...
`,Tt=`M11.83,9L15,12.16C15,12.11 15,12.05 15,12A3,3 0 0,0 12,9C11.94,9 11.89,9 11.83,9M7.53,9.8L9.08,11.35C9.03,11.56 9,11.77 9,12A3,3 0 0,0 12,15C12.22,15 12.44,14.97 12.65,14.92L14.2,16.47C13.53,16.8 12.79,17 12,17A5,5 0 0,1 7,12C7,11.21 7.2,10.47 7.53,9.8M2,4.27L4.28,6.55L4.73,7C3.08,8.3 1.78,10 1,12C2.73,16.39 7,19.5 12,19.5C13.55,19.5 15.03,19.2 16.38,18.66L16.81,19.08L19.73,22L21,20.73L3.27,3M12,7A5,5 0 0,1 17,12C17,12.64 16.87,13.26 16.64,13.82L19.57,16.75C21.07,15.5 22.27,13.86 23,12C21.27,7.61 17,4.5 12,4.5C10.6,4.5 9.26,4.75 8,5.2L10.17,7.35C10.74,7.13 11.35,7 12,7Z`;function Et(e){return e.config?.unit_system?.temperature===`°F`}function C(e){return Et(e)?`°F`:`°C`}function w(e,t){return Et(t)?e*9/5+32:e}function Dt(e,t){return Et(t)?(e-32)*5/9:e}function T(e,t){return Et(t)?e*9/5:e}function E(e,t,n=1){return w(e,t).toFixed(n)}function D(e){return Et(e)?`1`:`0.5`}function O(e,t,n){return{min:String(Math.round(w(e,n))),max:String(Math.round(w(t,n)))}}function k(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var A=t((()=>{}));_(),A();var j=class extends g{constructor(...e){super(...e),this.config=null,this.climateEntityCount=0,this.tempSensorCount=0,this.controlMode=`bangbang`,this.climateControlActive=!0,this.reordering=!1,this.canMoveUp=!1,this.canMoveDown=!1}static{this.styles=[wt,l`
  ...
  `}render(){return m`
    ...
    `}};k([y({attribute:!1})],N.prototype,`hass`,void 0),k([y({attribute:!1})],N.prototype,`area`,void 0),k([y({attribute:!1})],N.prototype,`config`,void 0),k([y({type:Boolean})],N.prototype,`climateControlActive`,void 0),k([y({type:Boolean})],N.prototype,`isOutdoor`,void 0),k([y({attribute:!1})],N.prototype,`overrideInfo`,void 0),k([b()],N.prototype,`_countdown`,void 0),k([b()],N.prototype,`_editingName`,void 0),k([b()],N.prototype,`_nameInput`,void 0),k([b()],N.prototype,`_controlModeInfoExpanded`,void 0),N=k([v(`rs-hero-status`)],N),_(),x(),A();var Ft=class extends g{constructor(...e){super(...e),this.climateMode=`auto`,this.language=`en`}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){let e=this.language;return m`
    ...
    `}_onModeClick(e){this.dispatchEvent(new CustomEvent(`mode-changed`,{detail:{mode:e},bubbles:!0,composed:!0}))}};k([y({type:String})],Ft.prototype,`climateMode`,void 0),k([y({type:String})],Ft.prototype,`language`,void 0),Ft=k([v(`rs-climate-mode-selector`)],Ft);function P(e){return e.detail?.value??e.target.value??``}function F(e,t){e.dispatchEvent(new CustomEvent(`save-status`,{detail:{status:t},bubbles:!0,composed:!0}))}function It(e,t){e.dispatchEvent(new CustomEvent(`hass-more-info`,{bubbles:!0,composed:!0,detail:{entityId:t}}))}_(),x(),A();var Lt=class e extends g{constructor(...e){super(...e),this.activeIndex=-1,this.selectorEntity=``,this.editing=!1}static{this.sharedStyles=l`
    :host {
      display: block;
    }
  ...
  `}static{this.ICON_CLOSE=`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`}static{this.ICON_UP=`M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z`}static{this.ICON_DOWN=`M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z`}_getScheduleState(e,t){if(t===0)return`inactive`;if(e===this.activeIndex)return`active`;if(!this.selectorEntity)return e===0?`active`:`unreachable`;let n=this.hass?.states?.[this.selectorEntity];if(!n)return`inactive`;if(this.selectorEntity.startsWith(`input_boolean.`))return e<=1?`inactive`:`unreachable`;if(this.selectorEntity.startsWith(`input_number.`)){let r=Number(n.attributes?.min??1),i=Number(n.attributes?.max??t);return e+1>=r&&e+1<=i?`inactive`:`unreachable`}return`inactive`}_getAvailableEntities(e){return this.hass?.states?Object.keys(this.hass.states).filter(t=>t.startsWith(`schedule.`)&&!e.has(t)):[]}_getFriendlyName(e){return this.hass?.states?.[e]?.attributes?.friendly_name||e}_renderAddRow(e,t,n,r){return m`
    ...
    `}_openEntityInfo(e){It(this,e)}};k([y({attribute:!1})],Lt.prototype,`hass`,void 0),k([y({type:Number})],Lt.prototype,`activeIndex`,void 0),k([y({type:String})],Lt.prototype,`selectorEntity`,void 0),k([y({type:Boolean})],Lt.prototype,`editing`,void 0),_();var I=l`
  ha-textfield,
  ha-select,
  ha-entity-picker,
  ha-combo-box {
...
`;_(),x(),A();var L=class extends Lt{constructor(...e){super(...e),this.schedules=[],this.comfortHeat=21,this.comfortCool=24,this.ecoHeat=17,this.ecoCool=27,this.climateMode=`auto`}set scheduleSelectorEntity(e){this.selectorEntity=e}get scheduleSelectorEntity(){return this.selectorEntity}set activeScheduleIndex(e){this.activeIndex=e}get activeScheduleIndex(){return this.activeIndex}static{this.styles=[Lt.sharedStyles,I,l`
      .fallback-hint {
        font-size: 11px;
        color: var(--secondary-text-color);
        margin-top: 4px;
...
`;_(),x(),A();var Vt=class extends g{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
    :host {
      display: block;
  ...
  `}render(){return m`<span class="badge" title=${this.hint}>${this.label}</span>`}};k([y({type:String})],Ht.prototype,`label`,void 0),k([y({type:String})],Ht.prototype,`hint`,void 0),Ht=k([v(`rs-badge`)],Ht),_(),x(),A();var Ut=`M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z`,Wt=class extends g{constructor(...e){super(...e),this.icon=``,this.heading=``,this.badge=``,this.badgeHint=``,this.editable=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onEditClick(){this.dispatchEvent(new CustomEvent(`edit-click`,{bubbles:!0,composed:!0}))}};k([y({type:String})],Wt.prototype,`icon`,void 0),k([y({type:String})],Wt.prototype,`heading`,void 0),k([y({type:String})],Wt.prototype,`badge`,void 0),k([y({type:String})],Wt.prototype,`badgeHint`,void 0),k([y({type:Boolean})],Wt.prototype,`editable`,void 0),Wt=k([v(`rs-section-card`)],Wt),_(),x(),A();var B=class extends g{constructor(...e){super(...e),this.climateMode=`auto`,this.comfortHeat=21,this.comfortCool=24,this.ecoHeat=17,this.ecoCool=27,this.language=`en`,this._overridePending=null,this._overrideCustomHeat=21,this._overrideCustomCool=24,this._overrideError=``,this._optimisticOverride=null,this._optimisticClear=!1}static{this.styles=[I,l`
      :host {
        display: block;
      }
  ...
  `}render(){return m`
    ...
    `}_onToggle(e){this.dispatchEvent(new CustomEvent(`toggle-changed`,{detail:e.target.checked,bubbles:!0,composed:!0}))}};k([y({type:String})],Gt.prototype,`label`,void 0),k([y({type:String})],Gt.prototype,`hint`,void 0),k([y({type:Boolean})],Gt.prototype,`checked`,void 0),k([y({type:Boolean})],Gt.prototype,`disabled`,void 0),Gt=k([v(`rs-toggle-row`)],Gt),_(),x(),A();var V=class extends g{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.selectedPresencePersons=[],this.ignorePresence=!1,this.editing=!1,this.language=`en`}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}get _allPersons(){let e=this.selectedPresencePersons.filter(e=>!this.presencePersons.includes(e));return[...this.presencePersons,...e]}_isMissing(e){return!this.hass.states[e]}render(){return!this.presenceEnabled||!this.editing&&this._allPersons.length===0?h:this.editing?m`
    ...
    `}_onIgnoreToggle(e){this.dispatchEvent(new CustomEvent(`ignore-presence-changed`,{detail:e.detail,bubbles:!0,composed:!0}))}_onTogglePerson(e,t){let n;n=t?this.selectedPresencePersons.filter(t=>t!==e):[...this.selectedPresencePersons,e],this.dispatchEvent(new CustomEvent(`presence-persons-changed`,{detail:n,bubbles:!0,composed:!0}))}};k([y({attribute:!1})],V.prototype,`hass`,void 0),k([y({type:Boolean})],V.prototype,`presenceEnabled`,void 0),k([y({attribute:!1})],V.prototype,`presencePersons`,void 0),k([y({attribute:!1})],V.prototype,`selectedPresencePersons`,void 0),k([y({type:Boolean})],V.prototype,`ignorePresence`,void 0),k([y({type:Boolean})],V.prototype,`editing`,void 0),k([y()],V.prototype,`language`,void 0),V=k([v(`rs-presence-section`)],V),_(),x(),A();var Kt=class extends g{constructor(...e){super(...e),this.label=``,this.suffix=``,this.hint=``}static{this.styles=[I,l`
      :host {
        display: block;
      }
    ...
    `}_onInput(e){let t=parseFloat(e.target.value);isNaN(t)||this.dispatchEvent(new CustomEvent(`value-changed`,{detail:t,bubbles:!0,composed:!0}))}};k([y({type:String})],Kt.prototype,`label`,void 0),k([y({type:String})],Kt.prototype,`suffix`,void 0),k([y({type:Number})],Kt.prototype,`value`,void 0),k([y({type:Number})],Kt.prototype,`min`,void 0),k([y({type:Number})],Kt.prototype,`max`,void 0),k([y({type:Number})],Kt.prototype,`step`,void 0),k([y({type:String})],Kt.prototype,`hint`,void 0),Kt=k([v(`rs-threshold-field`)],Kt),_(),x(),A();var qt=class extends Lt{constructor(...e){super(...e),this.schedules=[]}static{this.styles=[Lt.sharedStyles,I,l`
      .pos-badge {
        font-size: 0.8em;
        padding: 1px 6px;
        border-radius: 10px;
    ...
    `}_onSwitchChange(e){this._emit(`heat_source_orchestration`,e.target.checked)}_onNumberInput(e,t){let n=parseFloat(t.target.value);isNaN(n)||this._emit(e,n)}_emit(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}};k([y({attribute:!1})],U.prototype,`hass`,void 0),k([y({type:Boolean})],U.prototype,`enabled`,void 0),k([y({type:Boolean})],U.prototype,`native`,void 0),k([y({type:Number})],U.prototype,`heatPumpPower`,void 0),k([y({type:Number})],U.prototype,`primaryDelta`,void 0),k([y({type:Number})],U.prototype,`outdoorThreshold`,void 0),k([y({type:Number})],U.prototype,`acMinOutdoor`,void 0),k([y({type:Boolean})],U.prototype,`editing`,void 0),U=k([v(`rs-heat-source-section`)],U),_(),x(),A();var Yt=class extends g{constructor(...e){super(...e),this.icon=``,this.label=``,this.hint=``,this.checked=!1,this.disabled=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
      ...
      />
    `}_onChange(e){this.checked=e.target.checked,this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}},k([y({type:Boolean,reflect:!0})],tn.prototype,`checked`,void 0),k([y({type:Boolean,reflect:!0})],tn.prototype,`disabled`,void 0),k([y({type:String})],tn.prototype,`name`,void 0),k([y({type:String})],tn.prototype,`value`,void 0)})),rn=n({HaTextfieldPolyfill:()=>G}),G,an=t((()=>{_(),x(),A(),G=class extends g{constructor(...e){super(...e),this.value=``,this.type=`text`,this.label=``,this.placeholder=``,this.suffix=``,this.prefix=``,this.helper=``,this.disabled=!1,this.required=!1,this.readOnly=!1,this.min=``,this.max=``,this.step=null,this.name=``}static{this.shadowRootOptions={mode:`open`,delegatesFocus:!0}}static{this.styles=l`
    :host {
      display: inline-flex;
      flex-direction: column;
      outline: none;
  ...
  `}};k([y({type:String})],cn.prototype,`icon`,void 0),k([y({type:String})],cn.prototype,`heading`,void 0),k([y({type:String})],cn.prototype,`intro`,void 0),k([y({type:String})],cn.prototype,`badge`,void 0),k([y({type:String})],cn.prototype,`badgeHint`,void 0),cn=k([v(`rs-settings-panel`)],cn),_();var K=class extends g{_fire(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}static{this.settingsBaseStyles=l`
    :host {
      display: block;
    }
  ...
  `}};_(),x(),A();var ln=class extends K{constructor(...e){super(...e),this.groupByFloor=!1,this.climateControlActive=!0}render(){let e=this.hass.language;return m`
    ...
    `]}};k([y({attribute:!1})],un.prototype,`hass`,void 0),k([y({type:String})],un.prototype,`outdoorTempSensor`,void 0),k([y({type:String})],un.prototype,`outdoorHumiditySensor`,void 0),k([y({type:String})],un.prototype,`weatherEntity`,void 0),k([y({type:Boolean})],un.prototype,`outdoorUnavailableNotify`,void 0),un=k([v(`rs-settings-sensors`)],un),_(),x(),A();var dn=`https://github.com/snazzybean/roommind/blob/main/docs/control-and-devices.md`,q=class extends K{constructor(...e){super(...e),this.controlMode=`mpc`,this.comfortWeight=70,this.outdoorCoolingMin=16,this.outdoorHeatingMax=22,this.predictionEnabled=!0,this.scheduleOffAction=`eco`}render(){let e=this.hass.language;return m`
      <div class="settings-section first">
      ...
      <div class="settings-section">
        ...
        <a class="helper-link" href=${dn} target="_blank" rel="noreferrer">
          ${S(`common.learn_more`,e)}
        </a>
      </div>
    ...
    `]}};k([y({attribute:!1})],q.prototype,`hass`,void 0),k([y({type:String})],q.prototype,`controlMode`,void 0),k([y({type:Number})],q.prototype,`comfortWeight`,void 0),k([y({type:Number})],q.prototype,`outdoorCoolingMin`,void 0),k([y({type:Number})],q.prototype,`outdoorHeatingMax`,void 0),k([y({type:Boolean})],q.prototype,`predictionEnabled`,void 0),k([y({type:String})],q.prototype,`scheduleOffAction`,void 0),q=k([v(`rs-settings-control`)],q),_(),x(),A();var fn=class extends K{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.presenceAwayAction=`eco`,this.presenceClearsOverride=!1}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};k([y({attribute:!1})],fn.prototype,`hass`,void 0),k([y({type:Boolean})],fn.prototype,`presenceEnabled`,void 0),k([y({type:Array})],fn.prototype,`presencePersons`,void 0),k([y({type:String})],fn.prototype,`presenceAwayAction`,void 0),k([y({type:Boolean})],fn.prototype,`presenceClearsOverride`,void 0),fn=k([v(`rs-settings-presence`)],fn),_(),x(),A();var pn=class extends K{constructor(...e){super(...e),this.vacationActive=!1,this.vacationTemp=15,this.vacationUntil=``}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.vacationActive?m`
          ...
          `:h}
    `}static{this.styles=[K.settingsBaseStyles]}};k([y({attribute:!1})],pn.prototype,`hass`,void 0),k([y({type:Boolean})],pn.prototype,`vacationActive`,void 0),k([y({type:Number})],pn.prototype,`vacationTemp`,void 0),k([y({type:String})],pn.prototype,`vacationUntil`,void 0),pn=k([v(`rs-settings-vacation`)],pn),_(),x(),A();var mn=class extends K{constructor(...e){super(...e),this.valveProtectionEnabled=!1,this.valveProtectionInterval=7}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.valveProtectionEnabled?m`
          ...
          `:h}
    `}static{this.styles=[K.settingsBaseStyles]}};k([y({attribute:!1})],mn.prototype,`hass`,void 0),k([y({type:Boolean})],mn.prototype,`valveProtectionEnabled`,void 0),k([y({type:Number})],mn.prototype,`valveProtectionInterval`,void 0),mn=k([v(`rs-settings-valve`)],mn),_(),x(),A();var hn=class extends g{constructor(...e){super(...e),this.label=``,this.confirmMessage=``,this.disabled=!1,this.destructive=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onClick(){this.disabled||this.confirmMessage&&!confirm(this.confirmMessage)||this.dispatchEvent(new CustomEvent(`confirmed`,{bubbles:!0,composed:!0}))}};k([y({type:String})],hn.prototype,`label`,void 0),k([y({type:String})],hn.prototype,`confirmMessage`,void 0),k([y({type:Boolean})],hn.prototype,`disabled`,void 0),k([y({type:Boolean})],hn.prototype,`destructive`,void 0),hn=k([v(`rs-confirm-button`)],hn),_(),x(),A();var gn=class extends g{constructor(...e){super(...e),this.compressorGroups=[],this._memberFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0},this._masterFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0}}static{this.styles=[I,l`
      :host {
        display: block;
      }
      .group-card {
    ...
    `}_updateGroup(e,t,n){let r=[...this.compressorGroups];r[e]={...r[e],[t]:n},this._fire(r)}_addGroup(){this._fire([...this.compressorGroups,{id:self.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,name:``,members:[],min_run_minutes:15,min_off_minutes:5,master_entity:``,conflict_resolution:`heating_priority`,action_script:``,enforce_uniform_mode:!1}])}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`compressorGroups`,value:e},bubbles:!0,composed:!0}))}};k([y({attribute:!1})],gn.prototype,`hass`,void 0),k([y({type:Array})],gn.prototype,`compressorGroups`,void 0),gn=k([v(`rs-settings-compressor`)],gn),_(),x(),A();var _n=class extends K{constructor(...e){super(...e),this.moldDetectionEnabled=!1,this.moldHumidityThreshold=70,this.moldSustainedMinutes=30,this.moldPreventionEnabled=!1,this.moldPreventionIntensity=`medium`}render(){let e=this.hass.language;return m`
      <!-- Detection section -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}static{this.styles=[K.settingsBaseStyles]}};k([y({attribute:!1})],_n.prototype,`hass`,void 0),k([y({type:Boolean})],_n.prototype,`moldDetectionEnabled`,void 0),k([y({type:Number})],_n.prototype,`moldHumidityThreshold`,void 0),k([y({type:Number})],_n.prototype,`moldSustainedMinutes`,void 0),k([y({type:Boolean})],_n.prototype,`moldPreventionEnabled`,void 0),k([y({type:String})],_n.prototype,`moldPreventionIntensity`,void 0),_n=k([v(`rs-settings-mold`)],_n),_(),x(),A();var vn=class extends K{constructor(...e){super(...e),this.notificationsEnabled=!0,this.notificationTargets=[],this.notificationCooldown=60,this.moldPreventionEnabled=!1,this.moldPreventionNotify=!1}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};k([y({attribute:!1})],vn.prototype,`hass`,void 0),k([y({type:Boolean})],vn.prototype,`notificationsEnabled`,void 0),k([y({type:Array})],vn.prototype,`notificationTargets`,void 0),k([y({type:Number})],vn.prototype,`notificationCooldown`,void 0),k([y({type:Boolean})],vn.prototype,`moldPreventionEnabled`,void 0),k([y({type:Boolean})],vn.prototype,`moldPreventionNotify`,void 0),vn=k([v(`rs-settings-notifications`)],vn),_(),x(),A();var yn=250,bn=class extends K{constructor(...e){super(...e),this.rooms={},this.learningDisabledRooms=[],this.boostAppliedAt={},this.roomsLive={},this._showLearningExceptions=!1,this._boostSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name)),n=Object.keys(this.rooms),r=n.length===0||this.learningDisabledRooms.length<n.length,i=this.learningDisabledRooms.filter(e=>n.includes(e)).length;return m`
      <!-- Learning toggle -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}_isCooldown(e){let t=this.roomsLive?.[e]?.n_observations??0,n=this.boostAppliedAt[e];return n!==void 0&&t-n<yn}async _boostLearning(e){try{F(this,`saving`);let t=await this.hass.callWS({type:`roommind/model/boost_learning`,area_id:e});F(this,`saved`),this.dispatchEvent(new CustomEvent(`boost-applied`,{detail:{area_id:e,n_observations:t.n_observations},bubbles:!0,composed:!0}))}catch{F(this,`error`)}}static{this.styles=[K.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 4px 0 12px;
    ...
    `]}};k([y({attribute:!1})],bn.prototype,`hass`,void 0),k([y({attribute:!1})],bn.prototype,`rooms`,void 0),k([y({type:Array})],bn.prototype,`learningDisabledRooms`,void 0),k([y({attribute:!1})],bn.prototype,`boostAppliedAt`,void 0),k([y({attribute:!1})],bn.prototype,`roomsLive`,void 0),k([b()],bn.prototype,`_showLearningExceptions`,void 0),k([b()],bn.prototype,`_boostSelectedRoom`,void 0),bn=k([v(`rs-settings-learning`)],bn),_(),x(),A();var xn=class extends K{constructor(...e){super(...e),this.rooms={},this._resetSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name));return m`
      <div class="settings-section first">
        <div class="reset-row">
    ...
    `]}};k([y({attribute:!1})],xn.prototype,`hass`,void 0),k([y({attribute:!1})],xn.prototype,`rooms`,void 0),k([b()],xn.prototype,`_resetSelectedRoom`,void 0),xn=k([v(`rs-settings-reset`)],xn),_(),x(),A();var J=class extends g{constructor(...e){super(...e),this.boilerEntity=``,this.boilerControlType=`climate`,this.bypassEntities=[],this.startupDelay=30,this.shutdownDelay=60,this.bypassTemperature=28,this.budgetEnabled=!1,this.powerSensor=``,this.powerMode=`available`,this.maxPower=3300,this.reserve=200}render(){let e=(e,t)=>this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0})),t=(t,n)=>m`<ha-textfield
        type="number"
        .value=${String(n)}
        @change=${n=>e(t,Number(n.target.value))}
      ></ha-textfield>`;return m`<div class="section">
        <b>Central boiler</b>
        <ha-entity-picker
          .hass=${this.hass}
        ...
        ${this.boilerEntity?m`<ha-select
              ...
              <ha-entity-picker
                ...
                @value-changed=${t=>e(`bypassEntities`,t.detail.value||[])}
              ></ha-entity-picker>
              <label
      ...
      <div class="section">
        ...
        ${this.budgetEnabled?m`<ha-entity-picker
              ...
              ><ha-select
                ...
                @selected=${t=>e(`powerMode`,t.detail.value)}
  ...
  `}};k([y({attribute:!1})],Y.prototype,`hass`,void 0),k([y({attribute:!1})],Y.prototype,`rooms`,void 0),k([b()],Y.prototype,`_groupByFloor`,void 0),k([b()],Y.prototype,`_climateControlActive`,void 0),k([b()],Y.prototype,`_learningDisabledRooms`,void 0),k([b()],Y.prototype,`_outdoorTempSensor`,void 0),k([b()],Y.prototype,`_outdoorHumiditySensor`,void 0),k([b()],Y.prototype,`_outdoorCoolingMin`,void 0),k([b()],Y.prototype,`_outdoorHeatingMax`,void 0),k([b()],Y.prototype,`_controlMode`,void 0),k([b()],Y.prototype,`_comfortWeight`,void 0),k([b()],Y.prototype,`_weatherEntity`,void 0),k([b()],Y.prototype,`_outdoorUnavailableNotify`,void 0),k([b()],Y.prototype,`_predictionEnabled`,void 0),k([b()],Y.prototype,`_vacationActive`,void 0),k([b()],Y.prototype,`_vacationTemp`,void 0),k([b()],Y.prototype,`_vacationUntil`,void 0),k([b()],Y.prototype,`_presenceEnabled`,void 0),k([b()],Y.prototype,`_presencePersons`,void 0),k([b()],Y.prototype,`_presenceAwayAction`,void 0),k([b()],Y.prototype,`_presenceClearsOverride`,void 0),k([b()],Y.prototype,`_scheduleOffAction`,void 0),k([b()],Y.prototype,`_valveProtectionEnabled`,void 0),k([b()],Y.prototype,`_valveProtectionInterval`,void 0),k([b()],Y.prototype,`_moldDetectionEnabled`,void 0),k([b()],Y.prototype,`_moldHumidityThreshold`,void 0),k([b()],Y.prototype,`_moldSustainedMinutes`,void 0),k([b()],Y.prototype,`_moldNotificationCooldown`,void 0),k([b()],Y.prototype,`_moldNotificationsEnabled`,void 0),k([b()],Y.prototype,`_moldNotificationTargets`,void 0),k([b()],Y.prototype,`_moldPreventionEnabled`,void 0),k([b()],Y.prototype,`_moldPreventionIntensity`,void 0),k([b()],Y.prototype,`_moldPreventionNotify`,void 0),k([b()],Y.prototype,`_compressorGroups`,void 0),k([b()],Y.prototype,`_boostAppliedAt`,void 0),k([b()],Y.prototype,`_boilerEntity`,void 0),k([b()],Y.prototype,`_boilerControlType`,void 0),k([b()],Y.prototype,`_bypassEntities`,void 0),k([b()],Y.prototype,`_startupDelay`,void 0),k([b()],Y.prototype,`_shutdownDelay`,void 0),k([b()],Y.prototype,`_bypassTemperature`,void 0),k([b()],Y.prototype,`_budgetEnabled`,void 0),k([b()],Y.prototype,`_powerSensor`,void 0),k([b()],Y.prototype,`_powerMode`,void 0),k([b()],Y.prototype,`_maxPower`,void 0),k([b()],Y.prototype,`_reserve`,void 0),k([b()],Y.prototype,`_loaded`,void 0),Y=k([v(`rs-settings`)],Y);function Sn(e){let t=[...e.history,...e.detail];return t.length===0?null:[`timestamp,datetime,room_temp,outdoor_temp,target_temp,mode,predicted_temp,window_open,heating_power,solar_irradiance,blind_position,cover_reason,device_setpoint`,...t.map(e=>{let t=new Date(e.ts*1e3).toISOString(),n=e.room_temp??``,r=e.outdoor_temp??``,i=e.target_temp??``,a=e.predicted_temp??``,o=e.heating_power??``,s=e.solar_irradiance??``,c=e.blind_position??``,l=e.cover_reason??``,u=e.device_setpoint??``;return`${e.ts},${t},${n},${r},${i},${e.mode},${a},${e.window_open},${o},${s},${c},${l},${u}`})].join(`
`)}function Cn(e,t,n){let r=new Blob([e],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}function wn(e,t,n,r,i,a,o){let s=e?.areas?.[n],c=(t[n]?.display_name||s?.name||n).replace(/\s+/g,`_`).toLowerCase();return a?`roommind_${a}_${c}.${o}`:`roommind_${c}_${new Date(r).toISOString().slice(0,10)}_${new Date(i).toISOString().slice(0,10)}.${o}`}function Tn(e){return navigator.clipboard?.writeText?(navigator.clipboard.writeText(e).catch(()=>{En(e)}),!0):En(e)}function En(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch(e){console.debug(`[RoomMind] clipboard fallback:`,e)}return document.body.removeChild(t),n}_(),x(),A();var X=class extends g{constructor(...e){super(...e),this.rooms={},this.selectedRoom=``,this.rangeStart=0,this.rangeEnd=0,this.activeQuick=`24h`,this.data=null,this.language=`en`,this._openDropdown=null,this._diagLoading=!1,this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this._boundCloseDropdowns)}updated(e){(e.has(`rooms`)||e.has(`selectedRoom`))&&this.selectedRoom&&this.updateComplete.then(()=>{let e=this.renderRoot?.querySelector(`ha-select`);e&&e.value!==this.selectedRoom&&(e.value=this.selectedRoom)})}render(){let e=this.language,t=this._getConfiguredRooms();return m`
    ...
    `}_onRoomSelected(e){let t=P(e);t&&t!==this.selectedRoom&&this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0}))}_onQuickRange(e,t){let n=new Date,r=new Date(n);r.setDate(r.getDate()-(t-1)),r.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:e,rangeStart:r.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_onDateRangeChanged(e){let{startDate:t,endDate:n}=e.detail.value;!t||!n||this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:null,rangeStart:t.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_exportCsv(){if(!this.data)return;let e=Sn(this.data);e&&(Cn(e,wn(this.hass,this.rooms,this.selectedRoom,this.rangeStart,this.rangeEnd,``,`csv`),`text/csv`),this._openDropdown=null)}async _exportDiagnostics(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});Cn(JSON.stringify(e,null,2),`roommind_diagnostics.json`,`application/json`)}catch(e){console.warn(`[RoomMind] diagnostics export failed:`,e)}finally{this._diagLoading=!1}}}_copyCsvToClipboard(){if(!this.data)return;let e=Sn(this.data);e&&(Tn(e),this._openDropdown=null)}async _copyDiagnosticsToClipboard(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});Tn(JSON.stringify(e,null,2))}catch(e){console.warn(`[RoomMind] diagnostics clipboard failed:`,e)}finally{this._diagLoading=!1}}}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&=null}static{this.styles=[I,l`
      :host {
        display: block;
      }
    ...
    `]}};k([y({attribute:!1})],X.prototype,`hass`,void 0),k([y({attribute:!1})],X.prototype,`rooms`,void 0),k([y({type:String})],X.prototype,`selectedRoom`,void 0),k([y({type:Number})],X.prototype,`rangeStart`,void 0),k([y({type:Number})],X.prototype,`rangeEnd`,void 0),k([y({type:String})],X.prototype,`activeQuick`,void 0),k([y({attribute:!1})],X.prototype,`data`,void 0),k([y({type:String})],X.prototype,`language`,void 0),k([b()],X.prototype,`_openDropdown`,void 0),k([b()],X.prototype,`_diagLoading`,void 0),X=k([v(`rs-analytics-toolbar`)],X),_();var Dn=l`
  .info-icon {
    --mdc-icon-size: 16px;
    color: var(--secondary-text-color);
    opacity: 0.3;
...
`,On=108e5;function kn(e,t){let{hass:n,language:r,chartAnchor:i,forecast:a,isOutdoor:o}=t,s=e=>w(e,n),c=[],l=[],u=[],d=[],ee=[];for(let t of e){let e=t.ts*1e3;t.room_temp!==null&&c.push([e,s(t.room_temp)]),!o&&t.target_temp!==null&&l.push([e,s(t.target_temp)]),!o&&t.predicted_temp!==null&&u.push([e,s(t.predicted_temp)]),t.outdoor_temp!==null&&d.push([e,s(t.outdoor_temp)]),!o&&t.device_setpoint!=null&&ee.push([e,s(t.device_setpoint)])}for(let e of a??[]){let t=e.ts*1e3;!o&&e.target_temp!==null&&l.push([t,s(e.target_temp)]),!o&&e.predicted_temp!==null&&u.push([t,s(e.predicted_temp)])}let f=[{id:`room_temp`,type:`line`,name:S(`analytics.temperature`,r),color:`rgb(255, 152, 0)`,data:c,showSymbol:!1,smooth:!0,lineStyle:{width:2},yAxisIndex:0}];o||f.push({id:`target_temp`,type:`line`,name:S(`analytics.target`,r),color:`rgb(76, 175, 80)`,data:l,showSymbol:!1,smooth:!1,lineStyle:{width:2,type:`dashed`},yAxisIndex:0}),u.length>0&&f.push({id:`predicted_temp`,type:`line`,name:S(`analytics.prediction`,r),color:`rgb(33, 150, 243)`,data:u,showSymbol:!1,smooth:!0,lineStyle:{width:2,type:`dotted`},yAxisIndex:0}),ee.length>0&&f.push({id:`device_target`,type:`line`,name:`TRV / AC`,color:`rgb(156, 39, 176)`,data:ee,showSymbol:!1,smooth:!1,step:`end`,lineStyle:{width:1,type:`dashed`},yAxisIndex:0}),d.length>0&&f.push({id:`outdoor_temp`,type:`line`,name:S(`analytics.outdoor`,r),color:`rgb(158, 158, 158)`,data:d,showSymbol:!1,smooth:!0,lineStyle:{width:1},yAxisIndex:0});let te=[],ne=[],re=[],ie=!1,ae=!1,oe=!1;for(let t of e){let e=t.ts*1e3;t.mode===`heating`?(te.push([e,999]),ie=!0):te.push([e,null]),t.mode===`cooling`?(ne.push([e,999]),ae=!0):ne.push([e,null]),t.window_open?(re.push([e,999]),oe=!0):re.push([e,null])}return ie&&f.push({id:`heating_events`,type:`line`,name:S(`analytics.heating_period`,r),color:`rgb(244, 67, 54)`,data:te,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(244, 67, 54, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),ae&&f.push({id:`cooling_events`,type:`line`,name:S(`analytics.cooling_period`,r),color:`rgb(63, 81, 181)`,data:ne,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(63, 81, 181, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),oe&&f.push({id:`window_events`,type:`line`,name:S(`analytics.window_open_period`,r),color:`rgb(0, 150, 136)`,data:re,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(0, 150, 136, 0.1)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),f.push({id:`now_marker`,type:`line`,name:``,color:`rgba(255,255,255,0.3)`,data:[[i,-999],[i,999]],showSymbol:!1,lineStyle:{width:1,type:`dashed`},yAxisIndex:0,tooltip:{show:!1},z:-2}),f}function An(e,t,n){let{hass:r,language:i,chartAnchor:a,rangeStart:o,rangeEnd:s}=n,c=C(r),l={type:`value`,name:c};if(e.length>0){let t=1/0,n=-1/0;for(let r of e)r<t&&(t=r),r>n&&(n=r);let r=n-t,i=Math.max(r*.1,.5);l.min=Math.floor((t-i)*2)/2,l.max=Math.ceil((n+i)*2)/2}return{xAxis:{type:`time`,min:o,max:Math.abs(s-Date.now())<36e5?a+On:s},yAxis:l,dataZoom:[{type:`inside`,xAxisIndex:0,filterMode:`none`}],tooltip:{trigger:`axis`,axisPointer:{snap:!1},valueFormatter:e=>e.toFixed(1)+`\xA0`+c,formatter:e=>{if(!Array.isArray(e)||e.length===0)return``;let n=`<div style="font-weight:500;margin-bottom:4px">${new Date(e[0].value[0]).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}</div>`,a=null,o=null;for(let t of e){if(t.seriesId?.endsWith(`_events`))continue;let e=t.value?.[1];e!=null&&(n+=`<div>${t.color?`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.color};margin-right:6px"></span>`:``}${t.seriesName}: ${e.toFixed(1)}\u00A0${c}</div>`,t.seriesId===`room_temp`&&(a=e),t.seriesId===`predicted_temp`&&(o=e))}if(a!==null&&o!==null){let e=a-o;n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px">Delta: ${e>=0?`+`:``}${e.toFixed(2)}\u00A0${c}</div>`}if(t.length>0){let a=e[0].value[0]/1e3,o=null,s=1/0;for(let e of t){let t=Math.abs(e.ts-a);t<s&&(s=t,o=e)}if(o){let e=[];if(o.mode===`heating`){let t=o.heating_power;t!=null&&t>0&&t<100?e.push(`${S(`analytics.heating_period`,i)} ${t}%`):e.push(S(`analytics.heating_period`,i)),o.device_setpoint!=null&&e.push(`TRV ${E(o.device_setpoint,r)}\u00A0${c}`)}else o.mode===`cooling`&&(e.push(S(`analytics.cooling_period`,i)),o.device_setpoint!=null&&e.push(`AC ${E(o.device_setpoint,r)}\u00A0${c}`));o.window_open&&e.push(S(`analytics.window_open_period`,i)),e.length>0&&(n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px;color:rgba(255,255,255,0.7)">${e.join(` · `)}</div>`),o.blind_position!=null&&(n+=`<div style="color:rgba(255,255,255,0.7)">${S(`analytics.blind_position`,i)} ${100-o.blind_position}%</div>`)}}let s=document.createElement(`div`);return s.innerHTML=n,s}},grid:{top:15,left:10,right:10,bottom:5,containLabel:!0}}}_(),x(),A();var Z=class extends g{constructor(...e){super(...e),this.data=null,this.rangeStart=0,this.rangeEnd=0,this.chartAnchor=0,this.language=`en`,this.isOutdoor=!1,this._hiddenSeries=new Set([`outdoor_temp`,`device_target`]),this._chartInfoExpanded=!1}render(){let e=this.language,t=this.data?[...this.data.history,...this.data.detail]:[],n=[...t,...this.data?.forecast??[]],r={hass:this.hass,language:e,chartAnchor:this.chartAnchor,rangeStart:this.rangeStart,rangeEnd:this.rangeEnd,forecast:this.data?.forecast,isOutdoor:this.isOutdoor},i=t.length>0?kn(t,r):[],a=[],o=i.map(e=>{let t=e.id,n=e.lineStyle||{},r=t.endsWith(`_events`);if(this._hiddenSeries.has(t)){let t={...e,lineStyle:{...n,width:0,opacity:0}};return e.areaStyle&&(t.areaStyle={...e.areaStyle,opacity:0}),t}if(!r&&t!==`now_marker`)for(let t of e.data)t&&t[1]!=null&&a.push(t[1]);let i={...e,lineStyle:{...n,opacity:1}};return e.areaStyle&&(i.areaStyle={...e.areaStyle,opacity:1}),i}),s=An(a,n,r);return m`
      <ha-card>
        <div class="card-header">
...
`).map(e=>m`<p>
        ...
        </p>`)}_toggleSeries(e){let t=new Set(this._hiddenSeries);t.has(e)?t.delete(e):t.add(e),this._hiddenSeries=t}static{this.styles=[Dn,l`
      :host {
        display: block;
      }
      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          <div class="model-grid">
            ...
            ${te?p(`heating_rate`,re&&r?T(r.Q_heat,this.hass).toFixed(1)+C(this.hass)+`/h`:`—`,`analytics.heating_rate`,``,`analytics.info.heating_rate`):h}
            ${ne?p(`cooling_rate`,ie&&r?T(r.Q_cool,this.hass).toFixed(1)+C(this.hass)+`/h`:`—`,`analytics.cooling_rate`,``,`analytics.info.cooling_rate`):h}
            ${r&&r.Q_solar>.1?p(`solar_gain`,T(r.Q_solar,this.hass).toFixed(1)+C(this.hass)+`/h`,`analytics.solar_gain`,``,`analytics.info.solar_gain`):h}
            ${r&&n?.has_occupancy_sensors?p(`occupancy_gain`,T(r.Q_occupancy,this.hass).toFixed(1)+C(this.hass)+`/h`,`analytics.occupancy_gain`,``,`analytics.info.occupancy_gain`):h}
            ${p(`accuracy_idle`,ae&&l!=null?`±`+T(l,this.hass).toFixed(2)+C(this.hass):`—`,`analytics.accuracy_idle`,``,`analytics.info.accuracy_idle`)}
            ${te?p(`accuracy_heating`,re&&u!=null?`±`+T(u,this.hass).toFixed(2)+C(this.hass):`—`,`analytics.accuracy_heating`,``,`analytics.info.accuracy_heating`):h}
          </div>
    ...
    `}_toggleStat(e){this._expandedStat=this._expandedStat===e?null:e}static{this.styles=[Dn,l`
      :host {
        display: block;
      }
    ...
    `]}};k([y({attribute:!1})],jn.prototype,`hass`,void 0),k([y({attribute:!1})],jn.prototype,`data`,void 0),k([y({type:String})],jn.prototype,`language`,void 0),k([b()],jn.prototype,`_expandedStat`,void 0),jn=k([v(`rs-analytics-model`)],jn),_(),x(),A();var Q=class extends g{constructor(...e){super(...e),this.rooms={},this.initialRoom=``,this.controlMode=`bangbang`,this._selectedRoom=``,this._rangeStart=new Date(new Date().setHours(0,0,0,0)).getTime(),this._rangeEnd=Date.now(),this._data=null,this._chartAnchor=Date.now(),this._loading=!1,this._activeQuick=`24h`}connectedCallback(){super.connectedCallback(),this._refreshInterval=setInterval(()=>this._silentRefresh(),6e4)}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0)}willUpdate(e){e.has(`initialRoom`)&&this.initialRoom&&(this._selectedRoom=this.initialRoom);let t=!1;if(e.has(`rooms`)&&!this._selectedRoom){let e=Object.keys(this.rooms);e.length>0&&(this._selectedRoom=e[0],t=!0,this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:e[0]},bubbles:!0,composed:!0})))}(t||e.has(`_selectedRoom`)||e.has(`_rangeStart`)||e.has(`_rangeEnd`))&&this._selectedRoom&&this._fetchData()}render(){let e=this.hass.language;return m`
  ...
  `}connectedCallback(){super.connectedCallback(),on().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return m``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:S(`panel.tab.rooms`,e),analytics:S(`tabs.analytics`,e),settings:S(`panel.tab.settings`,e)};return m`
      <div class="toolbar">
        ...
        ${t&&this._rooms[this._selectedAreaId]?m`<ha-icon-button
              ...
              ></ha-icon-button
              ><ha-icon-button .path=${Nn} @click=${this._onDeleteRoom}></ha-icon-button>`:h}
