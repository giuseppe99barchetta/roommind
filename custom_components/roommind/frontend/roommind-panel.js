...
`;v(),S(),j();var Bt=class extends _{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
  ...
  `}render(){return h`<span class="badge" title=${this.hint}>${this.label}</span>`}};A([b({type:String})],Vt.prototype,`label`,void 0),A([b({type:String})],Vt.prototype,`hint`,void 0),Vt=A([y(`rs-badge`)],Vt),v(),S(),j();var Ht=`M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z`,Ut=class extends _{constructor(...e){super(...e),this.icon=``,this.heading=``,this.badge=``,this.badgeHint=``,this.editable=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return h`
    ...
    `}_onEditClick(){this.dispatchEvent(new CustomEvent(`edit-click`,{bubbles:!0,composed:!0}))}};A([b({type:String})],Ut.prototype,`icon`,void 0),A([b({type:String})],Ut.prototype,`heading`,void 0),A([b({type:String})],Ut.prototype,`badge`,void 0),A([b({type:String})],Ut.prototype,`badgeHint`,void 0),A([b({type:Boolean})],Ut.prototype,`editable`,void 0),Ut=A([y(`rs-section-card`)],Ut),v(),S(),j();var V=class extends _{constructor(...e){super(...e),this.climateMode=`auto`,this.comfortHeat=21,this.comfortCool=24,this.ecoHeat=17,this.ecoCool=27,this.language=`en`,this._overridePending=null,this._overrideCustomHeat=21,this._overrideCustomCool=24,this._overrideError=``,this._optimisticOverride=null,this._optimisticClear=!1}static{this.styles=[L,l`
      :host {
        display: block;
      }
  ...
  `}render(){return h`
    ...
    `}_onToggle(e){this.dispatchEvent(new CustomEvent(`toggle-changed`,{detail:e.target.checked,bubbles:!0,composed:!0}))}};A([b({type:String})],Wt.prototype,`label`,void 0),A([b({type:String})],Wt.prototype,`hint`,void 0),A([b({type:Boolean})],Wt.prototype,`checked`,void 0),A([b({type:Boolean})],Wt.prototype,`disabled`,void 0),Wt=A([y(`rs-toggle-row`)],Wt),v(),S(),j();var Gt=class extends _{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.selectedPresencePersons=[],this.ignorePresence=!1,this.editing=!1,this.language=`en`}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}get _allPersons(){let e=this.selectedPresencePersons.filter(e=>!this.presencePersons.includes(e));return[...this.presencePersons,...e]}_isMissing(e){return!this.hass.states[e]}render(){return!this.presenceEnabled||!this.editing&&this._allPersons.length===0?g:this.editing?h`
    ...
    `}_onIgnoreToggle(e){this.dispatchEvent(new CustomEvent(`ignore-presence-changed`,{detail:e.detail,bubbles:!0,composed:!0}))}_onTogglePerson(e,t){let n;n=t?this.selectedPresencePersons.filter(t=>t!==e):[...this.selectedPresencePersons,e],this.dispatchEvent(new CustomEvent(`presence-persons-changed`,{detail:n,bubbles:!0,composed:!0}))}};A([b({attribute:!1})],Gt.prototype,`hass`,void 0),A([b({type:Boolean})],Gt.prototype,`presenceEnabled`,void 0),A([b({attribute:!1})],Gt.prototype,`presencePersons`,void 0),A([b({attribute:!1})],Gt.prototype,`selectedPresencePersons`,void 0),A([b({type:Boolean})],Gt.prototype,`ignorePresence`,void 0),A([b({type:Boolean})],Gt.prototype,`editing`,void 0),A([b()],Gt.prototype,`language`,void 0),Gt=A([y(`rs-presence-section`)],Gt),v(),S(),j();var Kt=class extends _{constructor(...e){super(...e),this.label=``,this.suffix=``,this.hint=``}static{this.styles=[L,l`
      :host {
        display: block;
      }
    ...
    `}_onInput(e){let t=parseFloat(e.target.value);isNaN(t)||this.dispatchEvent(new CustomEvent(`value-changed`,{detail:t,bubbles:!0,composed:!0}))}};A([b({type:String})],Kt.prototype,`label`,void 0),A([b({type:String})],Kt.prototype,`suffix`,void 0),A([b({type:Number})],Kt.prototype,`value`,void 0),A([b({type:Number})],Kt.prototype,`min`,void 0),A([b({type:Number})],Kt.prototype,`max`,void 0),A([b({type:Number})],Kt.prototype,`step`,void 0),A([b({type:String})],Kt.prototype,`hint`,void 0),Kt=A([y(`rs-threshold-field`)],Kt),v(),S(),j();var qt=class extends It{constructor(...e){super(...e),this.schedules=[]}static{this.styles=[It.sharedStyles,L,l`
      .pos-badge {
        font-size: 0.8em;
        padding: 1px 6px;
        border-radius: 10px;
    ...
    `]}render(){let e=this.hass.language;return this.editing?this._renderEdit(e):this._renderView(e)}_renderView(e){let t=[...this.selectedCovers];return t.length===0?h`<p class="no-items">${C(`covers.no_covers`,e)}</p>`:h`
      ${t.map(t=>{let n=this.hass.states[t],r=n?.attributes?.friendly_name??t,i=n?.attributes?.current_position,a=this.coverOrientations[t],o=a===void 0?void 0:Jt._DIRECTIONS.find(e=>e.deg===a),s=o?C(o.shortLabel,e):void 0,c=this.coverMinPositions[t];return h`
          <div class="view-row">
      ...
      ${this.forcedReason===`schedule_active`?h`
          ...
          `:this.forcedReason===`night_close`?h`
            ...
            `:g}
    `}_renderMasterRow(e,t){let n=this.selectedCovers.has(e),r=this._selectedForEdit===e,i=this.hass.states[e],a=i?.attributes?.friendly_name||e,o=i?.attributes?.current_position,s=this.hass.language,c=this.coverOrientations[e],l=c===void 0?void 0:Jt._DIRECTIONS.find(e=>e.deg===c),u=l?C(l.shortLabel,s):``,d=this.coverMinPositions[e];return h`
      <div
    ...
    `}_renderCoverDetail(e){let t=this.hass.language,n=this.hass.states[e]?.attributes?.friendly_name||e,r=this.coverOrientations[e],i=this.coverMinPositions[e];return h`
      ...
      <div class="detail-field">
        <ha-select
          ...
          .options=${[{value:``,label:C(`covers.orientation_none`,t)},...Jt._DIRECTIONS.map(e=>({value:String(e.deg),label:C(e.longLabel,t)}))]}
          fixedMenuPosition
          @selected=${t=>{let n=F(t);this._setOrientation(e,n===``?void 0:Number(n))}}
          @closed=${e=>e.stopPropagation()}
        >
          <ha-list-item value="">${C(`covers.orientation_none`,t)}</ha-list-item>
          ${Jt._DIRECTIONS.map(e=>h`
    ...
    `}_onSwitchChange(e){this._emit(`heat_source_orchestration`,e.target.checked)}_onNumberInput(e,t){let n=parseFloat(t.target.value);isNaN(n)||this._emit(e,n)}_emit(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}};A([b({attribute:!1})],U.prototype,`hass`,void 0),A([b({type:Boolean})],U.prototype,`enabled`,void 0),A([b({type:Boolean})],U.prototype,`native`,void 0),A([b({type:Number})],U.prototype,`heatPumpPower`,void 0),A([b({type:Number})],U.prototype,`primaryDelta`,void 0),A([b({type:Number})],U.prototype,`outdoorThreshold`,void 0),A([b({type:Number})],U.prototype,`acMinOutdoor`,void 0),A([b({type:Boolean})],U.prototype,`editing`,void 0),U=A([y(`rs-heat-source-section`)],U),v(),S(),j();var Yt=class extends _{constructor(...e){super(...e),this.icon=``,this.label=``,this.hint=``,this.checked=!1,this.disabled=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return h`
    ...
    `}_onToggle(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-changed`,{detail:e.detail,bubbles:!0,composed:!0}))}};A([b({type:String})],Yt.prototype,`icon`,void 0),A([b({type:String})],Yt.prototype,`label`,void 0),A([b({type:String})],Yt.prototype,`hint`,void 0),A([b({type:Boolean})],Yt.prototype,`checked`,void 0),A([b({type:Boolean})],Yt.prototype,`disabled`,void 0),Yt=A([y(`rs-toggle-card`)],Yt),v(),S(),j();var Xt=`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,Zt=`M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z`,Qt=class extends _{constructor(...e){super(...e),this.open=!1,this.heading=``,this.icon=``,this.hasInfo=!1,this._infoExpanded=!1,this._onKeyDown=e=>{e.key===`Escape`&&this.open&&(e.stopPropagation(),this._close())}}connectedCallback(){super.connectedCallback(),window.addEventListener(`keydown`,this._onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`keydown`,this._onKeyDown)}static{this.styles=l`
    :host {
      display: contents;
    }
  ...
  `}render(){return h`
      ...
      />
    `}_onChange(e){this.checked=e.target.checked,this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}},A([b({type:Boolean,reflect:!0})],tn.prototype,`checked`,void 0),A([b({type:Boolean,reflect:!0})],tn.prototype,`disabled`,void 0),A([b({type:String})],tn.prototype,`name`,void 0),A([b({type:String})],tn.prototype,`value`,void 0)})),rn=n({HaTextfieldPolyfill:()=>G}),G,an=t((()=>{v(),S(),j(),G=class extends _{constructor(...e){super(...e),this.value=``,this.type=`text`,this.label=``,this.placeholder=``,this.suffix=``,this.prefix=``,this.helper=``,this.disabled=!1,this.required=!1,this.readOnly=!1,this.min=``,this.max=``,this.step=null,this.name=``}static{this.shadowRootOptions={mode:`open`,delegatesFocus:!0}}static{this.styles=l`
    :host {
      display: inline-flex;
      flex-direction: column;
      outline: none;
  ...
  `}};A([b({type:String})],pn.prototype,`icon`,void 0),A([b({type:String})],pn.prototype,`heading`,void 0),A([b({type:String})],pn.prototype,`intro`,void 0),A([b({type:String})],pn.prototype,`badge`,void 0),A([b({type:String})],pn.prototype,`badgeHint`,void 0),pn=A([y(`rs-settings-panel`)],pn),v();var K=class extends _{_fire(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}static{this.settingsBaseStyles=l`
    :host {
      display: block;
    }
  ...
  `}};v(),S(),j();var mn=class extends _{constructor(...e){super(...e),this.options=[],this.selected=``}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return h`
    ...
    `}_onRadioChange(e){let t=e.target;t.checked&&this.dispatchEvent(new CustomEvent(`selected-changed`,{detail:t.value,bubbles:!0,composed:!0}))}};A([b({type:Array})],mn.prototype,`options`,void 0),A([b({type:String})],mn.prototype,`selected`,void 0),mn=A([y(`rs-radio-group`)],mn),v(),S(),j();var hn=class extends K{constructor(...e){super(...e),this.groupByFloor=!1,this.climateControlActive=!0,this.temperatureRoundingMode=`nearest`}render(){let e=this.hass.language;return h`
    ...
    `]}};A([b({attribute:!1})],gn.prototype,`hass`,void 0),A([b({type:String})],gn.prototype,`outdoorTempSensor`,void 0),A([b({type:String})],gn.prototype,`outdoorHumiditySensor`,void 0),A([b({type:String})],gn.prototype,`weatherEntity`,void 0),A([b({type:Boolean})],gn.prototype,`outdoorUnavailableNotify`,void 0),gn=A([y(`rs-settings-sensors`)],gn),v(),S(),j();var _n=`https://github.com/snazzybean/roommind/blob/main/docs/control-and-devices.md`,vn=class extends K{constructor(...e){super(...e),this.controlMode=`mpc`,this.comfortWeight=70,this.outdoorCoolingMin=16,this.outdoorHeatingMax=22,this.predictionEnabled=!0,this.scheduleOffAction=`eco`}render(){let e=this.hass.language;return h`
      <div class="settings-section first">
      ...
      <div class="settings-section">
        ...
        <a class="helper-link" href=${_n} target="_blank" rel="noreferrer">
          ${C(`common.learn_more`,e)}
        </a>
      </div>
    ...
    `]}};A([b({attribute:!1})],vn.prototype,`hass`,void 0),A([b({type:String})],vn.prototype,`controlMode`,void 0),A([b({type:Number})],vn.prototype,`comfortWeight`,void 0),A([b({type:Number})],vn.prototype,`outdoorCoolingMin`,void 0),A([b({type:Number})],vn.prototype,`outdoorHeatingMax`,void 0),A([b({type:Boolean})],vn.prototype,`predictionEnabled`,void 0),A([b({type:String})],vn.prototype,`scheduleOffAction`,void 0),vn=A([y(`rs-settings-control`)],vn),v(),S(),j();var yn=class extends K{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.presenceAwayAction=`eco`,this.presenceClearsOverride=!1}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};A([b({attribute:!1})],yn.prototype,`hass`,void 0),A([b({type:Boolean})],yn.prototype,`presenceEnabled`,void 0),A([b({type:Array})],yn.prototype,`presencePersons`,void 0),A([b({type:String})],yn.prototype,`presenceAwayAction`,void 0),A([b({type:Boolean})],yn.prototype,`presenceClearsOverride`,void 0),yn=A([y(`rs-settings-presence`)],yn),v(),S(),j();var bn=class extends K{constructor(...e){super(...e),this.vacationActive=!1,this.vacationTemp=15,this.vacationUntil=``}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.vacationActive?h`
          ...
          `:g}
    `}static{this.styles=[K.settingsBaseStyles]}};A([b({attribute:!1})],bn.prototype,`hass`,void 0),A([b({type:Boolean})],bn.prototype,`vacationActive`,void 0),A([b({type:Number})],bn.prototype,`vacationTemp`,void 0),A([b({type:String})],bn.prototype,`vacationUntil`,void 0),bn=A([y(`rs-settings-vacation`)],bn),v(),S(),j();var xn=class extends K{constructor(...e){super(...e),this.valveProtectionEnabled=!1,this.valveProtectionInterval=7}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.valveProtectionEnabled?h`
          ...
          `:g}
    `}static{this.styles=[K.settingsBaseStyles]}};A([b({attribute:!1})],xn.prototype,`hass`,void 0),A([b({type:Boolean})],xn.prototype,`valveProtectionEnabled`,void 0),A([b({type:Number})],xn.prototype,`valveProtectionInterval`,void 0),xn=A([y(`rs-settings-valve`)],xn),v(),S(),j();var Sn=class extends _{constructor(...e){super(...e),this.label=``,this.confirmMessage=``,this.disabled=!1,this.destructive=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return h`
    ...
    `}_onClick(){this.disabled||this.confirmMessage&&!confirm(this.confirmMessage)||this.dispatchEvent(new CustomEvent(`confirmed`,{bubbles:!0,composed:!0}))}};A([b({type:String})],Sn.prototype,`label`,void 0),A([b({type:String})],Sn.prototype,`confirmMessage`,void 0),A([b({type:Boolean})],Sn.prototype,`disabled`,void 0),A([b({type:Boolean})],Sn.prototype,`destructive`,void 0),Sn=A([y(`rs-confirm-button`)],Sn),v(),S(),j();var Cn=class extends _{constructor(...e){super(...e),this.compressorGroups=[],this._memberFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0},this._masterFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0}}static{this.styles=[L,l`
      :host {
        display: block;
      }
      .group-card {
    ...
    `}_updateGroup(e,t,n){let r=[...this.compressorGroups];r[e]={...r[e],[t]:n},this._fire(r)}_addGroup(){this._fire([...this.compressorGroups,{id:self.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,name:``,members:[],min_run_minutes:15,min_off_minutes:5,master_entity:``,conflict_resolution:`heating_priority`,action_script:``,enforce_uniform_mode:!1}])}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`compressorGroups`,value:e},bubbles:!0,composed:!0}))}};A([b({attribute:!1})],Cn.prototype,`hass`,void 0),A([b({type:Array})],Cn.prototype,`compressorGroups`,void 0),Cn=A([y(`rs-settings-compressor`)],Cn),v(),S(),j();var wn=class extends K{constructor(...e){super(...e),this.moldDetectionEnabled=!1,this.moldHumidityThreshold=70,this.moldSustainedMinutes=30,this.moldPreventionEnabled=!1,this.moldPreventionIntensity=`medium`}render(){let e=this.hass.language;return h`
      <!-- Detection section -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}static{this.styles=[K.settingsBaseStyles]}};A([b({attribute:!1})],wn.prototype,`hass`,void 0),A([b({type:Boolean})],wn.prototype,`moldDetectionEnabled`,void 0),A([b({type:Number})],wn.prototype,`moldHumidityThreshold`,void 0),A([b({type:Number})],wn.prototype,`moldSustainedMinutes`,void 0),A([b({type:Boolean})],wn.prototype,`moldPreventionEnabled`,void 0),A([b({type:String})],wn.prototype,`moldPreventionIntensity`,void 0),wn=A([y(`rs-settings-mold`)],wn),v(),S(),j();var Tn=class extends K{constructor(...e){super(...e),this.notificationsEnabled=!0,this.notificationTargets=[],this.notificationCooldown=60,this.moldPreventionEnabled=!1,this.moldPreventionNotify=!1}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};A([b({attribute:!1})],Tn.prototype,`hass`,void 0),A([b({type:Boolean})],Tn.prototype,`notificationsEnabled`,void 0),A([b({type:Array})],Tn.prototype,`notificationTargets`,void 0),A([b({type:Number})],Tn.prototype,`notificationCooldown`,void 0),A([b({type:Boolean})],Tn.prototype,`moldPreventionEnabled`,void 0),A([b({type:Boolean})],Tn.prototype,`moldPreventionNotify`,void 0),Tn=A([y(`rs-settings-notifications`)],Tn),v(),S(),j();var En=250,Dn=class extends K{constructor(...e){super(...e),this.rooms={},this.learningDisabledRooms=[],this.boostAppliedAt={},this.roomsLive={},this._showLearningExceptions=!1,this._boostSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name)),n=Object.keys(this.rooms),r=n.length===0||this.learningDisabledRooms.length<n.length,i=this.learningDisabledRooms.filter(e=>n.includes(e)).length;return h`
      <!-- Learning toggle -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}_isCooldown(e){let t=this.roomsLive?.[e]?.n_observations??0,n=this.boostAppliedAt[e];return n!==void 0&&t-n<En}async _boostLearning(e){try{I(this,`saving`);let t=await this.hass.callWS({type:`roommind/model/boost_learning`,area_id:e});I(this,`saved`),this.dispatchEvent(new CustomEvent(`boost-applied`,{detail:{area_id:e,n_observations:t.n_observations},bubbles:!0,composed:!0}))}catch{I(this,`error`)}}static{this.styles=[K.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 4px 0 12px;
    ...
    `]}};A([b({attribute:!1})],Dn.prototype,`hass`,void 0),A([b({attribute:!1})],Dn.prototype,`rooms`,void 0),A([b({type:Array})],Dn.prototype,`learningDisabledRooms`,void 0),A([b({attribute:!1})],Dn.prototype,`boostAppliedAt`,void 0),A([b({attribute:!1})],Dn.prototype,`roomsLive`,void 0),A([x()],Dn.prototype,`_showLearningExceptions`,void 0),A([x()],Dn.prototype,`_boostSelectedRoom`,void 0),Dn=A([y(`rs-settings-learning`)],Dn),v(),S(),j();var On=class extends K{constructor(...e){super(...e),this.rooms={},this._resetSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name));return h`
      <div class="settings-section first">
        <div class="reset-row">
    ...
    `]}};A([b({attribute:!1})],On.prototype,`hass`,void 0),A([b({attribute:!1})],On.prototype,`rooms`,void 0),A([x()],On.prototype,`_resetSelectedRoom`,void 0),On=A([y(`rs-settings-reset`)],On),v(),S(),j();var kn={entity:{multiple:!0,filter:[{domain:`climate`}]}},q=class extends _{constructor(...e){super(...e),this.boilerEntity=``,this.boilerControlType=`climate`,this.bypassEntities=[],this.startupDelay=30,this.shutdownDelay=60,this.bypassTemperature=28,this.budgetEnabled=!1,this.powerSensor=``,this.powerMode=`available`,this.maxPower=3300,this.reserve=200,this.energyPricePerKwh=0,this._powerModeState={value:`available`,hasLocalChange:!1}}willUpdate(e){e.has(`powerMode`)&&(this._powerModeState=un(this._powerModeState,this.powerMode))}render(){let e=(e,t)=>this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0})),t=(t,n)=>h`<ha-textfield
        type="number"
        .value=${String(n)}
      ...
      <div class="section">
        ...
        ${this.budgetEnabled?h`<ha-entity-picker
              ...
              ><ha-select
                ...
                @selected=${t=>{let n=F(t);console.debug(`RoomMind power sensor mode selected`,{type:t.type,detail:t.detail,targetValue:t.target?.value,currentTargetValue:t.currentTarget?.value,value:n}),this._powerModeState=ln(n),e(`powerMode`,this._powerModeState.value)}}
              ></ha-select>
              <div class="grid">
...
`)}function jn(e,t,n){let r=new Blob([e],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}function Mn(e,t,n,r,i,a,o){let s=e?.areas?.[n],c=(t[n]?.display_name||s?.name||n).replace(/\s+/g,`_`).toLowerCase();return a?`roommind_${a}_${c}.${o}`:`roommind_${c}_${new Date(r).toISOString().slice(0,10)}_${new Date(i).toISOString().slice(0,10)}.${o}`}function Nn(e){return navigator.clipboard?.writeText?(navigator.clipboard.writeText(e).catch(()=>{Pn(e)}),!0):Pn(e)}function Pn(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch(e){console.debug(`[RoomMind] clipboard fallback:`,e)}return document.body.removeChild(t),n}v(),S(),j();var Y=class extends _{constructor(...e){super(...e),this.rooms={},this.selectedRoom=``,this.rangeStart=0,this.rangeEnd=0,this.activeQuick=`24h`,this.data=null,this.language=`en`,this._openDropdown=null,this._diagLoading=!1,this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this._boundCloseDropdowns)}updated(e){(e.has(`rooms`)||e.has(`selectedRoom`))&&this.selectedRoom&&this.updateComplete.then(()=>{let e=this.renderRoot?.querySelector(`ha-select`);e&&e.value!==this.selectedRoom&&(e.value=this.selectedRoom)})}render(){let e=this.language,t=this._getConfiguredRooms();return h`
    ...
    `}_onRoomSelected(e){let t=F(e);t&&t!==this.selectedRoom&&this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0}))}_onQuickRange(e,t){let n=new Date,r=new Date(n);r.setDate(r.getDate()-(t-1)),r.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:e,rangeStart:r.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_onDateRangeChanged(e){let{startDate:t,endDate:n}=e.detail.value;!t||!n||this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:null,rangeStart:t.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_exportCsv(){if(!this.data)return;let e=An(this.data);e&&(jn(e,Mn(this.hass,this.rooms,this.selectedRoom,this.rangeStart,this.rangeEnd,``,`csv`),`text/csv`),this._openDropdown=null)}async _exportDiagnostics(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});jn(JSON.stringify(e,null,2),`roommind_diagnostics.json`,`application/json`)}catch(e){console.warn(`[RoomMind] diagnostics export failed:`,e)}finally{this._diagLoading=!1}}}_copyCsvToClipboard(){if(!this.data)return;let e=An(this.data);e&&(Nn(e),this._openDropdown=null)}async _copyDiagnosticsToClipboard(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});Nn(JSON.stringify(e,null,2))}catch(e){console.warn(`[RoomMind] diagnostics clipboard failed:`,e)}finally{this._diagLoading=!1}}}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&=null}static{this.styles=[L,l`
      :host {
        display: block;
      }
      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          <div class="model-grid">
            ...
            ${ee?m(`heating_rate`,ne&&r?E(r.Q_heat,this.hass).toFixed(1)+w(this.hass)+`/h`:`—`,`analytics.heating_rate`,``,`analytics.info.heating_rate`):g}
            ${te?m(`cooling_rate`,re&&r?E(r.Q_cool,this.hass).toFixed(1)+w(this.hass)+`/h`:`—`,`analytics.cooling_rate`,``,`analytics.info.cooling_rate`):g}
            ${r&&r.Q_solar>.1?m(`solar_gain`,E(r.Q_solar,this.hass).toFixed(1)+w(this.hass)+`/h`,`analytics.solar_gain`,``,`analytics.info.solar_gain`):g}
            ${r&&n?.has_occupancy_sensors?m(`occupancy_gain`,E(r.Q_occupancy,this.hass).toFixed(1)+w(this.hass)+`/h`,`analytics.occupancy_gain`,``,`analytics.info.occupancy_gain`):g}
            ${m(`accuracy_idle`,ie&&l!=null?`±`+E(l,this.hass).toFixed(2)+w(this.hass):`—`,`analytics.accuracy_idle`,``,`analytics.info.accuracy_idle`)}
            ${ee?m(`accuracy_heating`,ne&&u!=null?`±`+E(u,this.hass).toFixed(2)+w(this.hass):`—`,`analytics.accuracy_heating`,``,`analytics.info.accuracy_heating`):g}
          </div>
  ...
  `}connectedCallback(){super.connectedCallback(),on().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return h``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:C(`panel.tab.rooms`,e),analytics:C(`tabs.analytics`,e),settings:C(`panel.tab.settings`,e)};return h`
      <div class="toolbar">
        ...
        ${t&&this._rooms[this._selectedAreaId]?h`<ha-icon-button
              ...
              ></ha-icon-button
              ><ha-icon-button .path=${Un} @click=${this._onDeleteRoom}></ha-icon-button>`:g}
