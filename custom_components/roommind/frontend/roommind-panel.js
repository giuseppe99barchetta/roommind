...
`).map(e=>h`<p>
  ...
  `}connectedCallback(){super.connectedCallback(),sn().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return h``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:C(`panel.tab.rooms`,e),analytics:C(`tabs.analytics`,e),settings:C(`panel.tab.settings`,e)};return h`
    ...
    `}willUpdate(e){e.has(`route`)&&this._routeApplied&&this._applyRoute(),(e.has(`_rooms`)||e.has(`hass`))&&(this._areaInfosCache=this._computeAreaInfos())}updated(e){e.has(`hass`)&&this.hass&&!this._roomsLoaded&&this._loadRooms(),e.has(`hass`)&&this.hass?.connection&&!this._boundConnectionReady&&(this._boundConnectionReady=()=>{this._loadRooms(),this.requestUpdate()},this.hass.connection.addEventListener(`ready`,this._boundConnectionReady))}_navigate(e){history.replaceState(null,``,`/roommind${e}`),window.dispatchEvent(new Event(`location-changed`))}_applyRoute(){let e=this.route?.path??``;e.startsWith(`/room/`)?(this._activeTab=`areas`,this._selectedAreaId=decodeURIComponent(e.slice(6))):e.startsWith(`/analytics/`)?(this._activeTab=`analytics`,this._selectedAreaId=null,this._analyticsRoom=decodeURIComponent(e.slice(11))):e===`/analytics`?(this._activeTab=`analytics`,this._selectedAreaId=null,this._analyticsRoom=``):e===`/settings`?(this._activeTab=`settings`,this._selectedAreaId=null):(this._activeTab=`areas`,this._selectedAreaId=null)}};A([b({attribute:!1})],$.prototype,`hass`,void 0),A([b({type:Boolean,reflect:!0})],$.prototype,`narrow`,void 0),A([b({type:Object})],$.prototype,`route`,void 0),A([b({type:Object})],$.prototype,`panel`,void 0),A([x()],$.prototype,`_activeTab`,void 0),A([x()],$.prototype,`_rooms`,void 0),A([x()],$.prototype,`_roomsLoaded`,void 0),A([x()],$.prototype,`_selectedAreaId`,void 0),A([x()],$.prototype,`_analyticsRoom`,void 0),A([x()],$.prototype,`_vacationActive`,void 0),A([x()],$.prototype,`_vacationTemp`,void 0),A([x()],$.prototype,`_vacationUntil`,void 0),A([x()],$.prototype,`_hiddenRooms`,void 0),A([x()],$.prototype,`_showHiddenRooms`,void 0),A([x()],$.prototype,`_controlMode`,void 0),A([x()],$.prototype,`_climateControlActive`,void 0),A([x()],$.prototype,`_presenceEnabled`,void 0),A([x()],$.prototype,`_valveProtectionEnabled`,void 0),A([x()],$.prototype,`_anyoneHome`,void 0),A([x()],$.prototype,`_presencePersons`,void 0),A([x()],$.prototype,`_presenceAwayAction`,void 0),A([x()],$.prototype,`_saveStatus`,void 0),A([x()],$.prototype,`_roomOrder`,void 0),A([x()],$.prototype,`_groupByFloor`,void 0),A([x()],$.prototype,`_reorderMode`,void 0),A([x()],$.prototype,`_elementsLoaded`,void 0),$=A([y(`roommind-panel`)],$)})();;(()=>{const t="rs-sensor-section",m=e=>{if(!e.editing||!e.hass||!e.area?.area_id||e.shadowRoot.querySelector(".roommind-night-profile")||e._roommindProfileLoading)return;e._roommindProfileLoading=!0;e.hass.callWS({type:"roommind/rooms/list"}).then(r=>{let o=r.rooms?.[e.area.area_id];if(!o)return;let n=document.createElement("div");n.className="roommind-night-profile";n.style.cssText="margin-top:16px;padding:14px;border:1px solid var(--divider-color);border-radius:10px;display:grid;gap:10px";n.innerHTML='<div style="font-weight:600">Modalit� notte e deumidificazione</div><label><input type="checkbox" data-k="night_mode_enabled"> Attiva modalit� notte</label><div style="display:flex;gap:8px"><label>Da <input type="time" data-k="night_start"></label><label>A <input type="time" data-k="night_end"></label></div><label>Rampa <input type="number" min="0" max="240" data-k="night_ramp_minutes"> min</label><div style="display:flex;gap:8px"><label>Delta caldo <input type="number" min="-5" max="0" step="0.1" data-k="night_heat_delta"> �C</label><label>Delta freddo <input type="number" min="0" max="5" step="0.1" data-k="night_cool_delta"> �C</label></div><label>Ventola notte <input type="text" data-k="night_fan_mode"></label><hr style="width:100%;border:0;border-top:1px solid var(--divider-color)"><label>Esponi deumidificazione come <select data-k="dry_entity_type"><option value="switch">Interruttore</option><option value="humidifier">Deumidificatore</option></select></label><div data-status style="font-size:12px;color:var(--secondary-text-color)"></div>';
for(const i of n.querySelectorAll("[data-k]")){let k=i.dataset.k,v=o[k];if(i.type==="checkbox")i.checked=!!v;else i.value=v??(k==="night_start"?"22:00":k==="night_end"?"07:00":k==="night_ramp_minutes"?60:k==="night_heat_delta"?-0.5:k==="night_cool_delta"?0.5:k==="night_fan_mode"?"low":"switch");i.addEventListener("change",async()=>{let d={type:"roommind/rooms/save",area_id:e.area.area_id};for(const x of n.querySelectorAll("[data-k]")){let q=x.dataset.k;d[q]=x.type==="checkbox"?x.checked:["night_ramp_minutes"].includes(q)?Number(x.value):["night_heat_delta","night_cool_delta"].includes(q)?Number(x.value):x.value}let s=n.querySelector("[data-status]");s.textContent="Salvataggio�";try{await e.hass.callWS(d);s.textContent="Salvato"}catch(a){s.textContent=`Errore: ${a.message||a}`}})}e.shadowRoot.querySelector(".block-body")?.append(n)}).finally(()=>e._roommindProfileLoading=!1)};customElements.whenDefined(t).then(()=>{let e=customElements.get(t),r=e.prototype.updated;e.prototype.updated=function(...o){r?.apply(this,o);queueMicrotask(()=>m(this))}})})();