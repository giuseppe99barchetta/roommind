...
`).map(e=>h`<p>
    ...
    `]}};A([b({attribute:!1})],Hn.prototype,`hass`,void 0),A([b({attribute:!1})],Hn.prototype,`data`,void 0),A([b({type:String})],Hn.prototype,`language`,void 0),A([x()],Hn.prototype,`_expandedStat`,void 0),Hn=A([y(`rs-analytics-model`)],Hn),v(),S(),j();var Q=class extends _{constructor(...e){super(...e),this.rooms={},this.initialRoom=``,this.controlMode=`bangbang`,this._selectedRoom=``,this._rangeStart=new Date(new Date().setHours(0,0,0,0)).getTime(),this._rangeEnd=Date.now(),this._data=null,this._chartAnchor=Date.now(),this._loading=!1,this._activeQuick=`24h`,this._comparison=[],this._comparisonInfoExpanded=!1}connectedCallback(){super.connectedCallback(),this._refreshInterval=setInterval(()=>this._silentRefresh(),6e4)}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0)}willUpdate(e){e.has(`initialRoom`)&&this.initialRoom&&(this._selectedRoom=this.initialRoom);let t=!1;if(e.has(`rooms`)&&!this._selectedRoom){let e=Object.keys(this.rooms);e.length>0&&(this._selectedRoom=e[0],t=!0,this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:e[0]},bubbles:!0,composed:!0})))}(t||e.has(`_selectedRoom`)||e.has(`_rangeStart`)||e.has(`_rangeEnd`))&&this._selectedRoom&&this._fetchData()}render(){let e=this.hass.language;return h`
              ...
              ${this.rooms[this._selectedRoom]?.is_outdoor?g:h`
                    ...
                    ${this._comparison.length>1?h`<ha-card class="comparison">
                          ...
                          <table>
                            ...
                            <tbody>
                              ${this._comparison.map(e=>h`<tr>
                                  <td>${e.name}</td><td>${e.energy_kwh??`—`}</td><td>${e.cost_eur??`—`}</td>
                                  <td>${e.active_minutes==null?`—`:`${e.active_minutes} min`}</td>
                                  <td>${e.delta_t_per_kwh??`—`}</td>
                                  <td>${e.target_reach_minutes==null?`—`:`${e.target_reach_minutes} min`}</td>
                                </tr>`)}
                            </tbody>
                          </table>
                        </ha-card>`:g}
  ...
  `}connectedCallback(){super.connectedCallback(),sn().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return h``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:C(`panel.tab.rooms`,e),analytics:C(`tabs.analytics`,e),settings:C(`panel.tab.settings`,e)};return h`
      <div class="toolbar">
        ...
        ${t&&this._rooms[this._selectedAreaId]?h`<ha-icon-button
              ...
              ></ha-icon-button
              ><ha-icon-button .path=${Wn} @click=${this._onDeleteRoom}></ha-icon-button>`:g}
