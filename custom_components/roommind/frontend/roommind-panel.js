...
`;_(),x(),j();var Bt=class extends g{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
  ...
  `}render(){return m`
    ...
    `}_onToggle(e){this.dispatchEvent(new CustomEvent(`toggle-changed`,{detail:e.target.checked,bubbles:!0,composed:!0}))}};A([y({type:String})],Wt.prototype,`label`,void 0),A([y({type:String})],Wt.prototype,`hint`,void 0),A([y({type:Boolean})],Wt.prototype,`checked`,void 0),A([y({type:Boolean})],Wt.prototype,`disabled`,void 0),Wt=A([v(`rs-toggle-row`)],Wt),_(),x(),j();var H=class extends g{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.selectedPresencePersons=[],this.ignorePresence=!1,this.editing=!1,this.language=`en`}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}get _allPersons(){let e=this.selectedPresencePersons.filter(e=>!this.presencePersons.includes(e));return[...this.presencePersons,...e]}_isMissing(e){return!this.hass.states[e]}render(){return!this.presenceEnabled||!this.editing&&this._allPersons.length===0?h:this.editing?m`
    ...
    `}_onIgnoreToggle(e){this.dispatchEvent(new CustomEvent(`ignore-presence-changed`,{detail:e.detail,bubbles:!0,composed:!0}))}_onTogglePerson(e,t){let n;n=t?this.selectedPresencePersons.filter(t=>t!==e):[...this.selectedPresencePersons,e],this.dispatchEvent(new CustomEvent(`presence-persons-changed`,{detail:n,bubbles:!0,composed:!0}))}};A([y({attribute:!1})],H.prototype,`hass`,void 0),A([y({type:Boolean})],H.prototype,`presenceEnabled`,void 0),A([y({attribute:!1})],H.prototype,`presencePersons`,void 0),A([y({attribute:!1})],H.prototype,`selectedPresencePersons`,void 0),A([y({type:Boolean})],H.prototype,`ignorePresence`,void 0),A([y({type:Boolean})],H.prototype,`editing`,void 0),A([y()],H.prototype,`language`,void 0),H=A([v(`rs-presence-section`)],H),_(),x(),j();var Gt=class extends g{constructor(...e){super(...e),this.label=``,this.suffix=``,this.hint=``}static{this.styles=[L,l`
      :host {
        display: block;
      }
    ...
    `}_onInput(e){let t=parseFloat(e.target.value);isNaN(t)||this.dispatchEvent(new CustomEvent(`value-changed`,{detail:t,bubbles:!0,composed:!0}))}};A([y({type:String})],Gt.prototype,`label`,void 0),A([y({type:String})],Gt.prototype,`suffix`,void 0),A([y({type:Number})],Gt.prototype,`value`,void 0),A([y({type:Number})],Gt.prototype,`min`,void 0),A([y({type:Number})],Gt.prototype,`max`,void 0),A([y({type:Number})],Gt.prototype,`step`,void 0),A([y({type:String})],Gt.prototype,`hint`,void 0),Gt=A([v(`rs-threshold-field`)],Gt),_(),x(),j();var Kt=class extends It{constructor(...e){super(...e),this.schedules=[]}static{this.styles=[It.sharedStyles,L,l`
      .pos-badge {
        font-size: 0.8em;
        padding: 1px 6px;
        border-radius: 10px;
    ...
    `}_onSwitchChange(e){this._emit(`heat_source_orchestration`,e.target.checked)}_onNumberInput(e,t){let n=parseFloat(t.target.value);isNaN(n)||this._emit(e,n)}_emit(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}};A([y({attribute:!1})],W.prototype,`hass`,void 0),A([y({type:Boolean})],W.prototype,`enabled`,void 0),A([y({type:Boolean})],W.prototype,`native`,void 0),A([y({type:Number})],W.prototype,`heatPumpPower`,void 0),A([y({type:Number})],W.prototype,`primaryDelta`,void 0),A([y({type:Number})],W.prototype,`outdoorThreshold`,void 0),A([y({type:Number})],W.prototype,`acMinOutdoor`,void 0),A([y({type:Boolean})],W.prototype,`editing`,void 0),W=A([v(`rs-heat-source-section`)],W),_(),x(),j();var Jt=class extends g{constructor(...e){super(...e),this.icon=``,this.label=``,this.hint=``,this.checked=!1,this.disabled=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onToggle(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-changed`,{detail:e.detail,bubbles:!0,composed:!0}))}};A([y({type:String})],Jt.prototype,`icon`,void 0),A([y({type:String})],Jt.prototype,`label`,void 0),A([y({type:String})],Jt.prototype,`hint`,void 0),A([y({type:Boolean})],Jt.prototype,`checked`,void 0),A([y({type:Boolean})],Jt.prototype,`disabled`,void 0),Jt=A([v(`rs-toggle-card`)],Jt),_(),x(),j();var Yt=`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,Xt=`M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z`,Zt=class extends g{constructor(...e){super(...e),this.open=!1,this.heading=``,this.icon=``,this.hasInfo=!1,this._infoExpanded=!1,this._onKeyDown=e=>{e.key===`Escape`&&this.open&&(e.stopPropagation(),this._close())}}connectedCallback(){super.connectedCallback(),window.addEventListener(`keydown`,this._onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`keydown`,this._onKeyDown)}static{this.styles=l`
    :host {
      display: contents;
    }
  ...
  `}render(){return m`
      ...
      />
    `}_onChange(e){this.checked=e.target.checked,this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}},A([y({type:Boolean,reflect:!0})],en.prototype,`checked`,void 0),A([y({type:Boolean,reflect:!0})],en.prototype,`disabled`,void 0),A([y({type:String})],en.prototype,`name`,void 0),A([y({type:String})],en.prototype,`value`,void 0)})),nn=n({HaTextfieldPolyfill:()=>K}),K,rn=t((()=>{_(),x(),j(),K=class extends g{constructor(...e){super(...e),this.value=``,this.type=`text`,this.label=``,this.placeholder=``,this.suffix=``,this.prefix=``,this.helper=``,this.disabled=!1,this.required=!1,this.readOnly=!1,this.min=``,this.max=``,this.step=null,this.name=``}static{this.shadowRootOptions={mode:`open`,delegatesFocus:!0}}static{this.styles=l`
    :host {
      display: inline-flex;
      flex-direction: column;
      outline: none;
  ...
  `}};A([y({type:String})],fn.prototype,`icon`,void 0),A([y({type:String})],fn.prototype,`heading`,void 0),A([y({type:String})],fn.prototype,`intro`,void 0),A([y({type:String})],fn.prototype,`badge`,void 0),A([y({type:String})],fn.prototype,`badgeHint`,void 0),fn=A([v(`rs-settings-panel`)],fn),_();var q=class extends g{_fire(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}static{this.settingsBaseStyles=l`
    :host {
      display: block;
    }
  ...
  `}};_(),x(),j();var pn=class extends g{constructor(...e){super(...e),this.options=[],this.selected=``}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onRadioChange(e){let t=e.target;t.checked&&this.dispatchEvent(new CustomEvent(`selected-changed`,{detail:t.value,bubbles:!0,composed:!0}))}};A([y({type:Array})],pn.prototype,`options`,void 0),A([y({type:String})],pn.prototype,`selected`,void 0),pn=A([v(`rs-radio-group`)],pn),_(),x(),j();var mn=class extends q{constructor(...e){super(...e),this.groupByFloor=!1,this.climateControlActive=!0,this.temperatureRoundingMode=`nearest`}render(){let e=this.hass.language;return m`
    ...
    `]}};A([y({attribute:!1})],hn.prototype,`hass`,void 0),A([y({type:String})],hn.prototype,`outdoorTempSensor`,void 0),A([y({type:String})],hn.prototype,`outdoorHumiditySensor`,void 0),A([y({type:String})],hn.prototype,`weatherEntity`,void 0),A([y({type:Boolean})],hn.prototype,`outdoorUnavailableNotify`,void 0),hn=A([v(`rs-settings-sensors`)],hn),_(),x(),j();var gn=`https://github.com/snazzybean/roommind/blob/main/docs/control-and-devices.md`,_n=class extends q{constructor(...e){super(...e),this.controlMode=`mpc`,this.comfortWeight=70,this.outdoorCoolingMin=16,this.outdoorHeatingMax=22,this.predictionEnabled=!0,this.scheduleOffAction=`eco`}render(){let e=this.hass.language;return m`
      <div class="settings-section first">
    ...
    `]}};A([y({attribute:!1})],_n.prototype,`hass`,void 0),A([y({type:String})],_n.prototype,`controlMode`,void 0),A([y({type:Number})],_n.prototype,`comfortWeight`,void 0),A([y({type:Number})],_n.prototype,`outdoorCoolingMin`,void 0),A([y({type:Number})],_n.prototype,`outdoorHeatingMax`,void 0),A([y({type:Boolean})],_n.prototype,`predictionEnabled`,void 0),A([y({type:String})],_n.prototype,`scheduleOffAction`,void 0),_n=A([v(`rs-settings-control`)],_n),_(),x(),j();var vn=class extends q{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.presenceAwayAction=`eco`,this.presenceClearsOverride=!1}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};A([y({attribute:!1})],vn.prototype,`hass`,void 0),A([y({type:Boolean})],vn.prototype,`presenceEnabled`,void 0),A([y({type:Array})],vn.prototype,`presencePersons`,void 0),A([y({type:String})],vn.prototype,`presenceAwayAction`,void 0),A([y({type:Boolean})],vn.prototype,`presenceClearsOverride`,void 0),vn=A([v(`rs-settings-presence`)],vn),_(),x(),j();var yn=class extends q{constructor(...e){super(...e),this.vacationActive=!1,this.vacationTemp=15,this.vacationUntil=``}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.vacationActive?m`
          ...
          `:h}
    `}static{this.styles=[q.settingsBaseStyles]}};A([y({attribute:!1})],yn.prototype,`hass`,void 0),A([y({type:Boolean})],yn.prototype,`vacationActive`,void 0),A([y({type:Number})],yn.prototype,`vacationTemp`,void 0),A([y({type:String})],yn.prototype,`vacationUntil`,void 0),yn=A([v(`rs-settings-vacation`)],yn),_(),x(),j();var bn=class extends q{constructor(...e){super(...e),this.valveProtectionEnabled=!1,this.valveProtectionInterval=7}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.valveProtectionEnabled?m`
          ...
          `:h}
    `}static{this.styles=[q.settingsBaseStyles]}};A([y({attribute:!1})],bn.prototype,`hass`,void 0),A([y({type:Boolean})],bn.prototype,`valveProtectionEnabled`,void 0),A([y({type:Number})],bn.prototype,`valveProtectionInterval`,void 0),bn=A([v(`rs-settings-valve`)],bn),_(),x(),j();var xn=class extends g{constructor(...e){super(...e),this.label=``,this.confirmMessage=``,this.disabled=!1,this.destructive=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onClick(){this.disabled||this.confirmMessage&&!confirm(this.confirmMessage)||this.dispatchEvent(new CustomEvent(`confirmed`,{bubbles:!0,composed:!0}))}};A([y({type:String})],xn.prototype,`label`,void 0),A([y({type:String})],xn.prototype,`confirmMessage`,void 0),A([y({type:Boolean})],xn.prototype,`disabled`,void 0),A([y({type:Boolean})],xn.prototype,`destructive`,void 0),xn=A([v(`rs-confirm-button`)],xn),_(),x(),j();var Sn=class extends g{constructor(...e){super(...e),this.compressorGroups=[],this._memberFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0},this._masterFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0}}static{this.styles=[L,l`
      :host {
        display: block;
      }
      .group-card {
    ...
    `}_updateGroup(e,t,n){let r=[...this.compressorGroups];r[e]={...r[e],[t]:n},this._fire(r)}_addGroup(){this._fire([...this.compressorGroups,{id:self.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,name:``,members:[],min_run_minutes:15,min_off_minutes:5,master_entity:``,conflict_resolution:`heating_priority`,action_script:``,enforce_uniform_mode:!1}])}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`compressorGroups`,value:e},bubbles:!0,composed:!0}))}};A([y({attribute:!1})],Sn.prototype,`hass`,void 0),A([y({type:Array})],Sn.prototype,`compressorGroups`,void 0),Sn=A([v(`rs-settings-compressor`)],Sn),_(),x(),j();var Cn=class extends q{constructor(...e){super(...e),this.moldDetectionEnabled=!1,this.moldHumidityThreshold=70,this.moldSustainedMinutes=30,this.moldPreventionEnabled=!1,this.moldPreventionIntensity=`medium`}render(){let e=this.hass.language;return m`
      <!-- Detection section -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}static{this.styles=[q.settingsBaseStyles]}};A([y({attribute:!1})],Cn.prototype,`hass`,void 0),A([y({type:Boolean})],Cn.prototype,`moldDetectionEnabled`,void 0),A([y({type:Number})],Cn.prototype,`moldHumidityThreshold`,void 0),A([y({type:Number})],Cn.prototype,`moldSustainedMinutes`,void 0),A([y({type:Boolean})],Cn.prototype,`moldPreventionEnabled`,void 0),A([y({type:String})],Cn.prototype,`moldPreventionIntensity`,void 0),Cn=A([v(`rs-settings-mold`)],Cn),_(),x(),j();var wn=class extends q{constructor(...e){super(...e),this.notificationsEnabled=!0,this.notificationTargets=[],this.notificationCooldown=60,this.moldPreventionEnabled=!1,this.moldPreventionNotify=!1}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};A([y({attribute:!1})],wn.prototype,`hass`,void 0),A([y({type:Boolean})],wn.prototype,`notificationsEnabled`,void 0),A([y({type:Array})],wn.prototype,`notificationTargets`,void 0),A([y({type:Number})],wn.prototype,`notificationCooldown`,void 0),A([y({type:Boolean})],wn.prototype,`moldPreventionEnabled`,void 0),A([y({type:Boolean})],wn.prototype,`moldPreventionNotify`,void 0),wn=A([v(`rs-settings-notifications`)],wn),_(),x(),j();var Tn=250,En=class extends q{constructor(...e){super(...e),this.rooms={},this.learningDisabledRooms=[],this.boostAppliedAt={},this.roomsLive={},this._showLearningExceptions=!1,this._boostSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name)),n=Object.keys(this.rooms),r=n.length===0||this.learningDisabledRooms.length<n.length,i=this.learningDisabledRooms.filter(e=>n.includes(e)).length;return m`
      <!-- Learning toggle -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}_isCooldown(e){let t=this.roomsLive?.[e]?.n_observations??0,n=this.boostAppliedAt[e];return n!==void 0&&t-n<Tn}async _boostLearning(e){try{I(this,`saving`);let t=await this.hass.callWS({type:`roommind/model/boost_learning`,area_id:e});I(this,`saved`),this.dispatchEvent(new CustomEvent(`boost-applied`,{detail:{area_id:e,n_observations:t.n_observations},bubbles:!0,composed:!0}))}catch{I(this,`error`)}}static{this.styles=[q.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 4px 0 12px;
    ...
    `]}};A([y({attribute:!1})],En.prototype,`hass`,void 0),A([y({attribute:!1})],En.prototype,`rooms`,void 0),A([y({type:Array})],En.prototype,`learningDisabledRooms`,void 0),A([y({attribute:!1})],En.prototype,`boostAppliedAt`,void 0),A([y({attribute:!1})],En.prototype,`roomsLive`,void 0),A([b()],En.prototype,`_showLearningExceptions`,void 0),A([b()],En.prototype,`_boostSelectedRoom`,void 0),En=A([v(`rs-settings-learning`)],En),_(),x(),j();var Dn=class extends q{constructor(...e){super(...e),this.rooms={},this._resetSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name));return m`
      <div class="settings-section first">
        <div class="reset-row">
    ...
    `}async _resetRoomModel(e){let t=this.hass.language;if(confirm(S(`settings.reset_room_confirm`,t)))try{I(this,`saving`),await this.hass.callWS({type:`roommind/thermal/reset`,area_id:e}),I(this,`saved`)}catch{I(this,`error`)}}async _resetAllModels(){let e=this.hass.language;if(confirm(S(`settings.reset_all_confirm`,e)))try{I(this,`saving`),await this.hass.callWS({type:`roommind/thermal/reset_all`}),I(this,`saved`)}catch{I(this,`error`)}}static{this.styles=[q.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 0;
    ...
    `]}};A([y({attribute:!1})],Dn.prototype,`hass`,void 0),A([y({attribute:!1})],Dn.prototype,`rooms`,void 0),A([b()],Dn.prototype,`_resetSelectedRoom`,void 0),Dn=A([v(`rs-settings-reset`)],Dn),_(),x(),j();var On={entity:{multiple:!0,filter:[{domain:`climate`}]}},J=class extends g{constructor(...e){super(...e),this.boilerEntity=``,this.boilerControlType=`climate`,this.bypassEntities=[],this.startupDelay=30,this.shutdownDelay=60,this.bypassTemperature=28,this.budgetEnabled=!1,this.powerSensor=``,this.powerMode=`available`,this.maxPower=3300,this.reserve=200,this.energyPricePerKwh=0,this._powerModeState={value:`available`,hasLocalChange:!1}}willUpdate(e){e.has(`powerMode`)&&(this._powerModeState=ln(this._powerModeState,this.powerMode))}render(){let e=(e,t)=>this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0})),t=(t,n)=>m`<ha-textfield
        type="number"
        .value=${String(n)}
      ...
      <div class="section">
        ...
        ${this.budgetEnabled?m`<ha-entity-picker
              ...
              ><ha-select
                ...
                @selected=${t=>{let n=F(t);console.debug(`RoomMind power sensor mode selected`,{type:t.type,detail:t.detail,targetValue:t.target?.value,currentTargetValue:t.currentTarget?.value,value:n}),this._powerModeState=cn(n),e(`powerMode`,this._powerModeState.value)}}
              ></ha-select>
              <div class="grid">
...
`)}function An(e,t,n){let r=new Blob([e],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}function jn(e,t,n,r,i,a,o){let s=e?.areas?.[n],c=(t[n]?.display_name||s?.name||n).replace(/\s+/g,`_`).toLowerCase();return a?`roommind_${a}_${c}.${o}`:`roommind_${c}_${new Date(r).toISOString().slice(0,10)}_${new Date(i).toISOString().slice(0,10)}.${o}`}function Mn(e){return navigator.clipboard?.writeText?(navigator.clipboard.writeText(e).catch(()=>{Nn(e)}),!0):Nn(e)}function Nn(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch(e){console.debug(`[RoomMind] clipboard fallback:`,e)}return document.body.removeChild(t),n}_(),x(),j();var X=class extends g{constructor(...e){super(...e),this.rooms={},this.selectedRoom=``,this.rangeStart=0,this.rangeEnd=0,this.activeQuick=`24h`,this.data=null,this.language=`en`,this._openDropdown=null,this._diagLoading=!1,this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this._boundCloseDropdowns)}updated(e){(e.has(`rooms`)||e.has(`selectedRoom`))&&this.selectedRoom&&this.updateComplete.then(()=>{let e=this.renderRoot?.querySelector(`ha-select`);e&&e.value!==this.selectedRoom&&(e.value=this.selectedRoom)})}render(){let e=this.language,t=this._getConfiguredRooms();return m`
    ...
    `}_onRoomSelected(e){let t=F(e);t&&t!==this.selectedRoom&&this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0}))}_onQuickRange(e,t){let n=new Date,r=new Date(n);r.setDate(r.getDate()-(t-1)),r.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:e,rangeStart:r.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_onDateRangeChanged(e){let{startDate:t,endDate:n}=e.detail.value;!t||!n||this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:null,rangeStart:t.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_exportCsv(){if(!this.data)return;let e=kn(this.data);e&&(An(e,jn(this.hass,this.rooms,this.selectedRoom,this.rangeStart,this.rangeEnd,``,`csv`),`text/csv`),this._openDropdown=null)}async _exportDiagnostics(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});An(JSON.stringify(e,null,2),`roommind_diagnostics.json`,`application/json`)}catch(e){console.warn(`[RoomMind] diagnostics export failed:`,e)}finally{this._diagLoading=!1}}}_copyCsvToClipboard(){if(!this.data)return;let e=kn(this.data);e&&(Mn(e),this._openDropdown=null)}async _copyDiagnosticsToClipboard(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});Mn(JSON.stringify(e,null,2))}catch(e){console.warn(`[RoomMind] diagnostics clipboard failed:`,e)}finally{this._diagLoading=!1}}}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&=null}static{this.styles=[L,l`
      :host {
        display: block;
      }
    ...
    `]}};A([y({attribute:!1})],X.prototype,`hass`,void 0),A([y({attribute:!1})],X.prototype,`rooms`,void 0),A([y({type:String})],X.prototype,`selectedRoom`,void 0),A([y({type:Number})],X.prototype,`rangeStart`,void 0),A([y({type:Number})],X.prototype,`rangeEnd`,void 0),A([y({type:String})],X.prototype,`activeQuick`,void 0),A([y({attribute:!1})],X.prototype,`data`,void 0),A([y({type:String})],X.prototype,`language`,void 0),A([b()],X.prototype,`_openDropdown`,void 0),A([b()],X.prototype,`_diagLoading`,void 0),X=A([v(`rs-analytics-toolbar`)],X),_();var Pn=l`
  .info-icon {
    --mdc-icon-size: 16px;
    color: var(--secondary-text-color);
    opacity: 0.3;
...
`).map(e=>m`<p>
    ...
    `]}};A([y({attribute:!1})],Z.prototype,`hass`,void 0),A([y({attribute:!1})],Z.prototype,`data`,void 0),A([y({type:Number})],Z.prototype,`rangeStart`,void 0),A([y({type:Number})],Z.prototype,`rangeEnd`,void 0),A([y({type:Number})],Z.prototype,`chartAnchor`,void 0),A([y({type:String})],Z.prototype,`language`,void 0),A([y({type:Boolean})],Z.prototype,`isOutdoor`,void 0),A([b()],Z.prototype,`_hiddenSeries`,void 0),A([b()],Z.prototype,`_chartInfoExpanded`,void 0),Z=A([v(`rs-analytics-chart`)],Z),_(),x(),j();var Rn=[`#03a9f4`,`#ff9800`,`#8bc34a`,`#9c27b0`,`#009688`,`#f44336`],zn=class extends g{constructor(...e){super(...e),this.data=null,this.language=`en`}_points(){return this.data?[...this.data.history,...this.data.detail]:[]}_deviceIds(e,t){let n=new Set;for(let r of[...e,...t]){for(let e of Object.keys(r.ac_device_power_w??{}))n.add(e);for(let e of Object.keys(r.predicted_device_power_w??{}))n.add(e)}return[...n].sort()}_friendlyName(e){let t=this.hass.states[e]?.attributes?.friendly_name;return typeof t==`string`&&t?t:e.split(`.`).pop().replaceAll(`_`,` `)}_integrate(e){let t=e.filter(e=>e.value!=null).sort((e,t)=>e.ts-t.ts),n=0;for(let e=1;e<t.length;e++){let r=Math.min(Math.max(t[e].ts-t[e-1].ts,0),900)/3600;n+=(t[e-1].value+t[e].value)/2*r}return n/1e3}render(){let e=this._points(),t=this.data?.forecast??[];if(!(e.some(e=>e.ac_power_w!=null)||t.some(e=>e.predicted_power_w!=null)))return h;let n=this._deviceIds(e,t),r=e.filter(e=>e.ac_power_w!=null).map(e=>[e.ts*1e3,e.ac_power_w]),i=t.filter(e=>e.predicted_power_w!=null).map(e=>[e.ts*1e3,e.predicted_power_w]),a=getComputedStyle(this).getPropertyValue(`--primary-color`).trim()||`#03a9f4`,o=[{id:`room_power`,name:S(`analytics.energy_room_power`,this.language),type:`line`,showSymbol:!1,data:r,color:a,lineStyle:{width:2.5},emphasis:{disabled:!0}}];i.length>0&&o.push({id:`room_power_forecast`,name:S(`analytics.energy_forecast`,this.language),type:`line`,showSymbol:!1,data:i,color:a,lineStyle:{width:2,type:`dashed`},emphasis:{disabled:!0}}),n.forEach((n,r)=>{let i=Rn[r%Rn.length],a=e.filter(e=>e.ac_device_power_w?.[n]!=null).map(e=>[e.ts*1e3,e.ac_device_power_w[n]]),s=t.filter(e=>e.predicted_device_power_w?.[n]!=null).map(e=>[e.ts*1e3,e.predicted_device_power_w[n]]);o.push({id:`device_${n}`,name:this._friendlyName(n),type:`line`,showSymbol:!1,data:a,color:i,lineStyle:{width:1.5,opacity:.75},emphasis:{disabled:!0}}),s.length&&o.push({id:`device_forecast_${n}`,name:`${this._friendlyName(n)} · ${S(`analytics.energy_forecast_short`,this.language)}`,type:`line`,showSymbol:!1,data:s,color:i,lineStyle:{width:1.5,type:`dashed`,opacity:.75},emphasis:{disabled:!0}})});let s=[...e].reverse().find(e=>e.ac_power_w!=null),c=this._integrate(e.map(e=>({ts:e.ts,value:e.ac_power_w}))),l=this._integrate(t.map(e=>({ts:e.ts,value:e.predicted_power_w}))),u=[...e].reverse().find(e=>e.energy_learning_samples!=null)?.energy_learning_samples??0,d=[...t,...e].reverse().find(e=>e.energy_prediction_confidence!=null)?.energy_prediction_confidence,f=this.data?.energy_cost;return m`
      <ha-card>
        ...
        ></ha-chart-base>
        <div class="legend">
          ${o.map(e=>m`<span><i style="background:${e.color}"></i>${e.name}</span>`)}
        </div>
      </ha-card>
    `}static{this.styles=l`
    :host {
  ...
  `}connectedCallback(){super.connectedCallback(),an().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return m``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:S(`panel.tab.rooms`,e),analytics:S(`tabs.analytics`,e),settings:S(`panel.tab.settings`,e)};return m`
      <div class="toolbar">
        ...
        ${t&&this._rooms[this._selectedAreaId]?m`<ha-icon-button
              ...
              ></ha-icon-button
              ><ha-icon-button .path=${Hn} @click=${this._onDeleteRoom}></ha-icon-button>`:h}
