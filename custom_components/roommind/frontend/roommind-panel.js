...
`;_(),x(),A();var Vt=class extends g{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
  ...
  `}};k([y({type:String})],pn.prototype,`icon`,void 0),k([y({type:String})],pn.prototype,`heading`,void 0),k([y({type:String})],pn.prototype,`intro`,void 0),k([y({type:String})],pn.prototype,`badge`,void 0),k([y({type:String})],pn.prototype,`badgeHint`,void 0),pn=k([v(`rs-settings-panel`)],pn),_();var K=class extends g{_fire(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}static{this.settingsBaseStyles=l`
    :host {
      display: block;
    }
  ...
  `}};_(),x(),A();var mn=class extends K{constructor(...e){super(...e),this.groupByFloor=!1,this.climateControlActive=!0}render(){let e=this.hass.language;return m`
    ...
    `]}};k([y({attribute:!1})],hn.prototype,`hass`,void 0),k([y({type:String})],hn.prototype,`outdoorTempSensor`,void 0),k([y({type:String})],hn.prototype,`outdoorHumiditySensor`,void 0),k([y({type:String})],hn.prototype,`weatherEntity`,void 0),k([y({type:Boolean})],hn.prototype,`outdoorUnavailableNotify`,void 0),hn=k([v(`rs-settings-sensors`)],hn),_(),x(),A();var gn=`https://github.com/snazzybean/roommind/blob/main/docs/control-and-devices.md`,q=class extends K{constructor(...e){super(...e),this.controlMode=`mpc`,this.comfortWeight=70,this.outdoorCoolingMin=16,this.outdoorHeatingMax=22,this.predictionEnabled=!0,this.scheduleOffAction=`eco`}render(){let e=this.hass.language;return m`
      <div class="settings-section first">
    ...
    `]}};k([y({attribute:!1})],_n.prototype,`hass`,void 0),k([y({type:Boolean})],_n.prototype,`presenceEnabled`,void 0),k([y({type:Array})],_n.prototype,`presencePersons`,void 0),k([y({type:String})],_n.prototype,`presenceAwayAction`,void 0),k([y({type:Boolean})],_n.prototype,`presenceClearsOverride`,void 0),_n=k([v(`rs-settings-presence`)],_n),_(),x(),A();var vn=class extends K{constructor(...e){super(...e),this.vacationActive=!1,this.vacationTemp=15,this.vacationUntil=``}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.vacationActive?m`
          ...
          `:h}
    `}static{this.styles=[K.settingsBaseStyles]}};k([y({attribute:!1})],vn.prototype,`hass`,void 0),k([y({type:Boolean})],vn.prototype,`vacationActive`,void 0),k([y({type:Number})],vn.prototype,`vacationTemp`,void 0),k([y({type:String})],vn.prototype,`vacationUntil`,void 0),vn=k([v(`rs-settings-vacation`)],vn),_(),x(),A();var yn=class extends K{constructor(...e){super(...e),this.valveProtectionEnabled=!1,this.valveProtectionInterval=7}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.valveProtectionEnabled?m`
          ...
          `:h}
    `}static{this.styles=[K.settingsBaseStyles]}};k([y({attribute:!1})],yn.prototype,`hass`,void 0),k([y({type:Boolean})],yn.prototype,`valveProtectionEnabled`,void 0),k([y({type:Number})],yn.prototype,`valveProtectionInterval`,void 0),yn=k([v(`rs-settings-valve`)],yn),_(),x(),A();var bn=class extends g{constructor(...e){super(...e),this.label=``,this.confirmMessage=``,this.disabled=!1,this.destructive=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onClick(){this.disabled||this.confirmMessage&&!confirm(this.confirmMessage)||this.dispatchEvent(new CustomEvent(`confirmed`,{bubbles:!0,composed:!0}))}};k([y({type:String})],bn.prototype,`label`,void 0),k([y({type:String})],bn.prototype,`confirmMessage`,void 0),k([y({type:Boolean})],bn.prototype,`disabled`,void 0),k([y({type:Boolean})],bn.prototype,`destructive`,void 0),bn=k([v(`rs-confirm-button`)],bn),_(),x(),A();var xn=class extends g{constructor(...e){super(...e),this.compressorGroups=[],this._memberFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0},this._masterFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0}}static{this.styles=[I,l`
      :host {
        display: block;
      }
      .group-card {
    ...
    `}_updateGroup(e,t,n){let r=[...this.compressorGroups];r[e]={...r[e],[t]:n},this._fire(r)}_addGroup(){this._fire([...this.compressorGroups,{id:self.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,name:``,members:[],min_run_minutes:15,min_off_minutes:5,master_entity:``,conflict_resolution:`heating_priority`,action_script:``,enforce_uniform_mode:!1}])}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`compressorGroups`,value:e},bubbles:!0,composed:!0}))}};k([y({attribute:!1})],xn.prototype,`hass`,void 0),k([y({type:Array})],xn.prototype,`compressorGroups`,void 0),xn=k([v(`rs-settings-compressor`)],xn),_(),x(),A();var Sn=class extends K{constructor(...e){super(...e),this.moldDetectionEnabled=!1,this.moldHumidityThreshold=70,this.moldSustainedMinutes=30,this.moldPreventionEnabled=!1,this.moldPreventionIntensity=`medium`}render(){let e=this.hass.language;return m`
      <!-- Detection section -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}static{this.styles=[K.settingsBaseStyles]}};k([y({attribute:!1})],Sn.prototype,`hass`,void 0),k([y({type:Boolean})],Sn.prototype,`moldDetectionEnabled`,void 0),k([y({type:Number})],Sn.prototype,`moldHumidityThreshold`,void 0),k([y({type:Number})],Sn.prototype,`moldSustainedMinutes`,void 0),k([y({type:Boolean})],Sn.prototype,`moldPreventionEnabled`,void 0),k([y({type:String})],Sn.prototype,`moldPreventionIntensity`,void 0),Sn=k([v(`rs-settings-mold`)],Sn),_(),x(),A();var Cn=class extends K{constructor(...e){super(...e),this.notificationsEnabled=!0,this.notificationTargets=[],this.notificationCooldown=60,this.moldPreventionEnabled=!1,this.moldPreventionNotify=!1}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};k([y({attribute:!1})],Cn.prototype,`hass`,void 0),k([y({type:Boolean})],Cn.prototype,`notificationsEnabled`,void 0),k([y({type:Array})],Cn.prototype,`notificationTargets`,void 0),k([y({type:Number})],Cn.prototype,`notificationCooldown`,void 0),k([y({type:Boolean})],Cn.prototype,`moldPreventionEnabled`,void 0),k([y({type:Boolean})],Cn.prototype,`moldPreventionNotify`,void 0),Cn=k([v(`rs-settings-notifications`)],Cn),_(),x(),A();var wn=250,Tn=class extends K{constructor(...e){super(...e),this.rooms={},this.learningDisabledRooms=[],this.boostAppliedAt={},this.roomsLive={},this._showLearningExceptions=!1,this._boostSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name)),n=Object.keys(this.rooms),r=n.length===0||this.learningDisabledRooms.length<n.length,i=this.learningDisabledRooms.filter(e=>n.includes(e)).length;return m`
      <!-- Learning toggle -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}_isCooldown(e){let t=this.roomsLive?.[e]?.n_observations??0,n=this.boostAppliedAt[e];return n!==void 0&&t-n<wn}async _boostLearning(e){try{F(this,`saving`);let t=await this.hass.callWS({type:`roommind/model/boost_learning`,area_id:e});F(this,`saved`),this.dispatchEvent(new CustomEvent(`boost-applied`,{detail:{area_id:e,n_observations:t.n_observations},bubbles:!0,composed:!0}))}catch{F(this,`error`)}}static{this.styles=[K.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 4px 0 12px;
    ...
    `]}};k([y({attribute:!1})],Tn.prototype,`hass`,void 0),k([y({attribute:!1})],Tn.prototype,`rooms`,void 0),k([y({type:Array})],Tn.prototype,`learningDisabledRooms`,void 0),k([y({attribute:!1})],Tn.prototype,`boostAppliedAt`,void 0),k([y({attribute:!1})],Tn.prototype,`roomsLive`,void 0),k([b()],Tn.prototype,`_showLearningExceptions`,void 0),k([b()],Tn.prototype,`_boostSelectedRoom`,void 0),Tn=k([v(`rs-settings-learning`)],Tn),_(),x(),A();var En=class extends K{constructor(...e){super(...e),this.rooms={},this._resetSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name));return m`
      <div class="settings-section first">
        <div class="reset-row">
    ...
    `]}};k([y({attribute:!1})],En.prototype,`hass`,void 0),k([y({attribute:!1})],En.prototype,`rooms`,void 0),k([b()],En.prototype,`_resetSelectedRoom`,void 0),En=k([v(`rs-settings-reset`)],En),_(),x(),A();var Dn={entity:{multiple:!0,filter:[{domain:`climate`}]}},J=class extends g{constructor(...e){super(...e),this.boilerEntity=``,this.boilerControlType=`climate`,this.bypassEntities=[],this.startupDelay=30,this.shutdownDelay=60,this.bypassTemperature=28,this.budgetEnabled=!1,this.powerSensor=``,this.powerMode=`available`,this.maxPower=3300,this.reserve=200,this._powerModeState={value:`available`,hasLocalChange:!1}}willUpdate(e){e.has(`powerMode`)&&(this._powerModeState=un(this._powerModeState,this.powerMode))}render(){let e=(e,t)=>this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0})),t=(t,n)=>m`<ha-textfield
        type="number"
        .value=${String(n)}
      ...
      <div class="section">
        ...
        ${this.budgetEnabled?m`<ha-entity-picker
              ...
              ><ha-select
                ...
                @selected=${t=>{let n=P(t);console.debug(`RoomMind power sensor mode selected`,{type:t.type,detail:t.detail,targetValue:t.target?.value,currentTargetValue:t.currentTarget?.value,value:n}),this._powerModeState=ln(n),e(`powerMode`,this._powerModeState.value)}}
              ></ha-select>
              <div class="grid">
...
`)}function kn(e,t,n){let r=new Blob([e],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}function An(e,t,n,r,i,a,o){let s=e?.areas?.[n],c=(t[n]?.display_name||s?.name||n).replace(/\s+/g,`_`).toLowerCase();return a?`roommind_${a}_${c}.${o}`:`roommind_${c}_${new Date(r).toISOString().slice(0,10)}_${new Date(i).toISOString().slice(0,10)}.${o}`}function jn(e){return navigator.clipboard?.writeText?(navigator.clipboard.writeText(e).catch(()=>{Mn(e)}),!0):Mn(e)}function Mn(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch(e){console.debug(`[RoomMind] clipboard fallback:`,e)}return document.body.removeChild(t),n}_(),x(),A();var X=class extends g{constructor(...e){super(...e),this.rooms={},this.selectedRoom=``,this.rangeStart=0,this.rangeEnd=0,this.activeQuick=`24h`,this.data=null,this.language=`en`,this._openDropdown=null,this._diagLoading=!1,this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this._boundCloseDropdowns)}updated(e){(e.has(`rooms`)||e.has(`selectedRoom`))&&this.selectedRoom&&this.updateComplete.then(()=>{let e=this.renderRoot?.querySelector(`ha-select`);e&&e.value!==this.selectedRoom&&(e.value=this.selectedRoom)})}render(){let e=this.language,t=this._getConfiguredRooms();return m`
    ...
    `}_onRoomSelected(e){let t=P(e);t&&t!==this.selectedRoom&&this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0}))}_onQuickRange(e,t){let n=new Date,r=new Date(n);r.setDate(r.getDate()-(t-1)),r.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:e,rangeStart:r.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_onDateRangeChanged(e){let{startDate:t,endDate:n}=e.detail.value;!t||!n||this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:null,rangeStart:t.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_exportCsv(){if(!this.data)return;let e=On(this.data);e&&(kn(e,An(this.hass,this.rooms,this.selectedRoom,this.rangeStart,this.rangeEnd,``,`csv`),`text/csv`),this._openDropdown=null)}async _exportDiagnostics(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});kn(JSON.stringify(e,null,2),`roommind_diagnostics.json`,`application/json`)}catch(e){console.warn(`[RoomMind] diagnostics export failed:`,e)}finally{this._diagLoading=!1}}}_copyCsvToClipboard(){if(!this.data)return;let e=On(this.data);e&&(jn(e),this._openDropdown=null)}async _copyDiagnosticsToClipboard(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});jn(JSON.stringify(e,null,2))}catch(e){console.warn(`[RoomMind] diagnostics clipboard failed:`,e)}finally{this._diagLoading=!1}}}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&=null}static{this.styles=[I,l`
      :host {
        display: block;
      }
    ...
    `]}};k([y({attribute:!1})],X.prototype,`hass`,void 0),k([y({attribute:!1})],X.prototype,`rooms`,void 0),k([y({type:String})],X.prototype,`selectedRoom`,void 0),k([y({type:Number})],X.prototype,`rangeStart`,void 0),k([y({type:Number})],X.prototype,`rangeEnd`,void 0),k([y({type:String})],X.prototype,`activeQuick`,void 0),k([y({attribute:!1})],X.prototype,`data`,void 0),k([y({type:String})],X.prototype,`language`,void 0),k([b()],X.prototype,`_openDropdown`,void 0),k([b()],X.prototype,`_diagLoading`,void 0),X=k([v(`rs-analytics-toolbar`)],X),_();var Nn=l`
  .info-icon {
    --mdc-icon-size: 16px;
    color: var(--secondary-text-color);
    opacity: 0.3;
...
`).map(e=>m`<p>
    ...
    `]}};k([y({attribute:!1})],Ln.prototype,`hass`,void 0),k([y({attribute:!1})],Ln.prototype,`data`,void 0),k([y({type:String})],Ln.prototype,`language`,void 0),k([b()],Ln.prototype,`_expandedStat`,void 0),Ln=k([v(`rs-analytics-model`)],Ln),_(),x(),A();var Q=class extends g{constructor(...e){super(...e),this.rooms={},this.initialRoom=``,this.controlMode=`bangbang`,this._selectedRoom=``,this._rangeStart=new Date(new Date().setHours(0,0,0,0)).getTime(),this._rangeEnd=Date.now(),this._data=null,this._chartAnchor=Date.now(),this._loading=!1,this._activeQuick=`24h`}connectedCallback(){super.connectedCallback(),this._refreshInterval=setInterval(()=>this._silentRefresh(),6e4)}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0)}willUpdate(e){e.has(`initialRoom`)&&this.initialRoom&&(this._selectedRoom=this.initialRoom);let t=!1;if(e.has(`rooms`)&&!this._selectedRoom){let e=Object.keys(this.rooms);e.length>0&&(this._selectedRoom=e[0],t=!0,this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:e[0]},bubbles:!0,composed:!0})))}(t||e.has(`_selectedRoom`)||e.has(`_rangeStart`)||e.has(`_rangeEnd`))&&this._selectedRoom&&this._fetchData()}render(){let e=this.hass.language;return m`
  ...
  `}connectedCallback(){super.connectedCallback(),on().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return m``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:S(`panel.tab.rooms`,e),analytics:S(`tabs.analytics`,e),settings:S(`panel.tab.settings`,e)};return m`
      <div class="toolbar">
        ...
        ${t&&this._rooms[this._selectedAreaId]?m`<ha-icon-button
              ...
              ></ha-icon-button
              ><ha-icon-button .path=${zn} @click=${this._onDeleteRoom}></ha-icon-button>`:h}
