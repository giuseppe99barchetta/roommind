...
`,Tt=`M11.83,9L15,12.16C15,12.11 15,12.05 15,12A3,3 0 0,0 12,9C11.94,9 11.89,9 11.83,9M7.53,9.8L9.08,11.35C9.03,11.56 9,11.77 9,12A3,3 0 0,0 12,15C12.22,15 12.44,14.97 12.65,14.92L14.2,16.47C13.53,16.8 12.79,17 12,17A5,5 0 0,1 7,12C7,11.21 7.2,10.47 7.53,9.8M2,4.27L4.28,6.55L4.73,7C3.08,8.3 1.78,10 1,12C2.73,16.39 7,19.5 12,19.5C13.55,19.5 15.03,19.2 16.38,18.66L16.81,19.08L19.73,22L21,20.73L3.27,3M12,7A5,5 0 0,1 17,12C17,12.64 16.87,13.26 16.64,13.82L19.57,16.75C21.07,15.5 22.27,13.86 23,12C21.27,7.61 17,4.5 12,4.5C10.6,4.5 9.26,4.75 8,5.2L10.17,7.35C10.74,7.13 11.35,7 12,7Z`;function Et(e){return e.config?.unit_system?.temperature===`°F`}function C(e){return Et(e)?`°F`:`°C`}function w(e,t){return Et(t)?e*9/5+32:e}function T(e,t){return Et(t)?(e-32)*5/9:e}function E(e,t){return Et(t)?e*9/5:e}function D(e,t,n=1){return w(e,t).toFixed(n)}function O(e){return Et(e)?`1`:`0.5`}function k(e,t,n){return{min:String(Math.round(w(e,n))),max:String(Math.round(w(t,n)))}}function A(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var j=t((()=>{}));_(),j();var M=class extends g{constructor(...e){super(...e),this.config=null,this.climateEntityCount=0,this.tempSensorCount=0,this.controlMode=`bangbang`,this.climateControlActive=!0,this.reordering=!1,this.canMoveUp=!1,this.canMoveDown=!1}static{this.styles=[wt,l`
  ...
  `}render(){return m`
    ...
    `}};A([y({attribute:!1})],P.prototype,`hass`,void 0),A([y({attribute:!1})],P.prototype,`area`,void 0),A([y({attribute:!1})],P.prototype,`config`,void 0),A([y({type:Boolean})],P.prototype,`climateControlActive`,void 0),A([y({type:Boolean})],P.prototype,`isOutdoor`,void 0),A([y({attribute:!1})],P.prototype,`overrideInfo`,void 0),A([b()],P.prototype,`_countdown`,void 0),A([b()],P.prototype,`_editingName`,void 0),A([b()],P.prototype,`_nameInput`,void 0),A([b()],P.prototype,`_controlModeInfoExpanded`,void 0),P=A([v(`rs-hero-status`)],P),_(),x(),j();var Pt={window_open:`insights.decision.window_open`,power_budget:`insights.decision.power_budget`,compressor_min_off:`insights.decision.compressor_min_off`,compressor_min_run:`insights.decision.compressor_min_run`,override_boost:`insights.decision.override_boost`,override_eco:`insights.decision.override_eco`,override_custom:`insights.decision.override_custom`,override_active:`insights.decision.override_active`,presence_away:`insights.decision.presence_away`,mold_prevention:`insights.decision.mold_prevention`,humidity_comfort:`insights.decision.humidity_comfort`,smart_ventilation:`insights.decision.smart_ventilation`,preconditioning:`insights.decision.preconditioning`,heat_source:`insights.decision.heat_source`,mode_heating:`insights.decision.mode_heating`,mode_cooling:`insights.decision.mode_cooling`,mode_idle:`insights.decision.mode_idle`},Ft=class extends g{constructor(...e){super(...e),this.decisionReasons=[]}static{this.styles=l`
    :host {
      display: block;
    }
    ha-card {
      ...
      <ha-card>
        <div class="insights-grid">
          <section>
            ...
            ${t.slice(0,3).map(t=>m`
                  <div class="decision">
                    <ha-icon icon="mdi:information-outline"></ha-icon>${S(Pt[t]??`insights.decision.mode_idle`,e)}
                  </div>
                `)}
          </section>
          ${this.readiness?m`<section>
        ...
        ${this.comfortScore?.breakdown?m`<section class="score-breakdown">
              <h3>${S(`insights.comfort.title`,e)}</h3>
              <div class="summary">${S(`insights.comfort.summary`,e)}</div>
              <div class="score-base">
                <span>${S(`insights.comfort.base`,e)}</span>
                <span>100</span>
              </div>
              ${Object.entries(this.comfortScore.breakdown).map(([t,n])=>m`
                  <div class="score-factor">
                    <span
                      >${S(`insights.comfort.factor.${t}.${n.status}`,e)}</span
                    >
                    <span class=${n.penalty?`penalty`:`neutral`}>
                      ${n.penalty?`−${n.penalty}`:S(`insights.comfort.no_penalty`,e)}
                    </span>
                  </div>
                `)}
              <div class="score-base">
                <span>${S(`insights.comfort.total`,e)}</span>
                <span>${this.comfortScore.score}/100</span>
              </div>
            </section>`:h}
      </ha-card>
    `}};A([y({attribute:!1})],Ft.prototype,`hass`,void 0),A([y({attribute:!1})],Ft.prototype,`readiness`,void 0),A([y({type:Array})],Ft.prototype,`decisionReasons`,void 0),A([y({attribute:!1})],Ft.prototype,`comfortScore`,void 0),Ft=A([v(`rs-room-insights`)],Ft),_(),x(),j();var It=class extends g{constructor(...e){super(...e),this.climateMode=`auto`,this.language=`en`}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){let e=this.language;return m`
    ...
    `}_onModeClick(e){this.dispatchEvent(new CustomEvent(`mode-changed`,{detail:{mode:e},bubbles:!0,composed:!0}))}};A([y({type:String})],It.prototype,`climateMode`,void 0),A([y({type:String})],It.prototype,`language`,void 0),It=A([v(`rs-climate-mode-selector`)],It);function F(e){return e.detail?.value??e.target.value??``}function I(e,t){e.dispatchEvent(new CustomEvent(`save-status`,{detail:{status:t},bubbles:!0,composed:!0}))}function Lt(e,t){e.dispatchEvent(new CustomEvent(`hass-more-info`,{bubbles:!0,composed:!0,detail:{entityId:t}}))}_(),x(),j();var Rt=class e extends g{constructor(...e){super(...e),this.activeIndex=-1,this.selectorEntity=``,this.editing=!1}static{this.sharedStyles=l`
    :host {
      display: block;
    }
  ...
  `}static{this.ICON_CLOSE=`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`}static{this.ICON_UP=`M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z`}static{this.ICON_DOWN=`M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z`}_getScheduleState(e,t){if(t===0)return`inactive`;if(e===this.activeIndex)return`active`;if(!this.selectorEntity)return e===0?`active`:`unreachable`;let n=this.hass?.states?.[this.selectorEntity];if(!n)return`inactive`;if(this.selectorEntity.startsWith(`input_boolean.`))return e<=1?`inactive`:`unreachable`;if(this.selectorEntity.startsWith(`input_number.`)){let r=Number(n.attributes?.min??1),i=Number(n.attributes?.max??t);return e+1>=r&&e+1<=i?`inactive`:`unreachable`}return`inactive`}_getAvailableEntities(e){return this.hass?.states?Object.keys(this.hass.states).filter(t=>t.startsWith(`schedule.`)&&!e.has(t)):[]}_getFriendlyName(e){return this.hass?.states?.[e]?.attributes?.friendly_name||e}_renderAddRow(e,t,n,r){return m`
    ...
    `}_openEntityInfo(e){Lt(this,e)}};A([y({attribute:!1})],Rt.prototype,`hass`,void 0),A([y({type:Number})],Rt.prototype,`activeIndex`,void 0),A([y({type:String})],Rt.prototype,`selectorEntity`,void 0),A([y({type:Boolean})],Rt.prototype,`editing`,void 0),_();var L=l`
  ha-textfield,
  ha-select,
  ha-entity-picker,
  ha-combo-box {
...
`;_(),x(),j();var R=class extends Rt{constructor(...e){super(...e),this.schedules=[],this.comfortHeat=21,this.comfortCool=24,this.ecoHeat=17,this.ecoCool=27,this.climateMode=`auto`}set scheduleSelectorEntity(e){this.selectorEntity=e}get scheduleSelectorEntity(){return this.selectorEntity}set activeScheduleIndex(e){this.activeIndex=e}get activeScheduleIndex(){return this.activeIndex}static{this.styles=[Rt.sharedStyles,L,l`
      .fallback-hint {
        font-size: 11px;
        color: var(--secondary-text-color);
        margin-top: 4px;
...
`;_(),x(),j();var Ht=class extends g{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
    :host {
      display: block;
  ...
  `}render(){return m`
    ...
    `}_renderViewRow(e,t){let n=this.hass.states[e],r=n?.attributes?.friendly_name||e,i=n?.state,a=n?.attributes??{},o=``;if(t===`climate`){let e=a.current_temperature;e!=null&&(o=`${e.toFixed(1)}${C(this.hass)}`)}else if(t===`temp`){let t=e.startsWith(`climate.`)?a.current_temperature:i;t!=null&&t!==``&&t!==`unknown`&&t!==`unavailable`&&(o=`${Number(t).toFixed(1)}${C(this.hass)}`)}else i&&i!==`unknown`&&i!==`unavailable`&&(o=`${Math.round(Number(i))}%`);let s=t===`climate`&&this.valveProtectionEnabled&&this.valveProtectionExclude.has(e),c=t===`climate`?this.devices.find(t=>t.entity_id===e):void 0,l=c?.idle_action===`fan_only`||c?.idle_action===`setback`||c?.idle_action===`low`,u=c?.setpoint_mode===`direct`&&!!this.selectedTempSensor;return m`
      <div class="view-row">
        <span class="view-name entity-link" @click=${()=>Lt(this,e)}
          >${r}</span
        >
    ...
    `}_onSelectForEdit(e){this._selectedForEdit=e}_renderDeviceDetail(e){let t=this.devices.find(t=>t.entity_id===e);if(!t)return h;let n=t.type===`trv`,r=t.type===`ac`,i=this.hass.states[e],a=i?.attributes?.friendly_name||e,o=(i?.attributes?.hvac_modes??[]).includes(`fan_only`),s=this.valveProtectionExclude.has(e),c=this.hass.language;return m`
      ...
      ${r?m`
            ...
            ${t.idle_action===`fan_only`?m`<div class="detail-field fan-only-conditions">
                  ...
                  ${Ut.map(({option:n,label:r})=>m`<label class="fan-only-condition">
                      <ha-checkbox
                        .checked=${!!t[n]}
  ...
  `}render(){return m`<span class="badge" title=${this.hint}>${this.label}</span>`}};A([y({type:String})],Wt.prototype,`label`,void 0),A([y({type:String})],Wt.prototype,`hint`,void 0),Wt=A([v(`rs-badge`)],Wt),_(),x(),j();var Gt=`M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z`,Kt=class extends g{constructor(...e){super(...e),this.icon=``,this.heading=``,this.badge=``,this.badgeHint=``,this.editable=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onEditClick(){this.dispatchEvent(new CustomEvent(`edit-click`,{bubbles:!0,composed:!0}))}};A([y({type:String})],Kt.prototype,`icon`,void 0),A([y({type:String})],Kt.prototype,`heading`,void 0),A([y({type:String})],Kt.prototype,`badge`,void 0),A([y({type:String})],Kt.prototype,`badgeHint`,void 0),A([y({type:Boolean})],Kt.prototype,`editable`,void 0),Kt=A([v(`rs-section-card`)],Kt),_(),x(),j();var V=class extends g{constructor(...e){super(...e),this.climateMode=`auto`,this.comfortHeat=21,this.comfortCool=24,this.ecoHeat=17,this.ecoCool=27,this.language=`en`,this._overridePending=null,this._overrideCustomHeat=21,this._overrideCustomCool=24,this._overrideError=``,this._optimisticOverride=null,this._optimisticClear=!1}static{this.styles=[L,l`
      :host {
        display: block;
      }
  ...
  `}render(){return m`
    ...
    `}_onToggle(e){this.dispatchEvent(new CustomEvent(`toggle-changed`,{detail:e.target.checked,bubbles:!0,composed:!0}))}};A([y({type:String})],qt.prototype,`label`,void 0),A([y({type:String})],qt.prototype,`hint`,void 0),A([y({type:Boolean})],qt.prototype,`checked`,void 0),A([y({type:Boolean})],qt.prototype,`disabled`,void 0),qt=A([v(`rs-toggle-row`)],qt),_(),x(),j();var Jt=[``,`work`,`sleep`,`guests`,`away`],H=class extends g{constructor(...e){super(...e),this.activeProfile=``,this.nightModeEnabled=!1,this.nightStart=`22:00`,this.nightEnd=`07:00`,this.nightHeatDelta=-.5,this.nightCoolDelta=.5,this.nightRampMinutes=60}static{this.styles=l`
    :host { display: block; }
  ...
  `}render(){let e=this.hass.language;return m`
      ...
      <div class="profile-grid">
        ${Jt.map(t=>m`<button
            class=${`${t?``:`default`} ${this.activeProfile===t?`active`:``}`}
    ...
    `}_timeField(e,t,n){return m`<label>${S(e,this.hass.language)}<input type="time" .value=${t} @change=${e=>this._emit(n,e.target.value)} /></label>`}_numberField(e,t,n,r,i,a,o=!1){return m`<label class=${o?`wide`:``}>${S(e,this.hass.language)}<input type="number" min=${r} max=${i} step=${a} .value=${String(t)} @change=${e=>{let t=Number(e.target.value);Number.isNaN(t)||this._emit(n,t)}} /></label>`}_emit(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}};A([y({attribute:!1})],H.prototype,`hass`,void 0),A([y({type:String})],H.prototype,`activeProfile`,void 0),A([y({type:Boolean})],H.prototype,`nightModeEnabled`,void 0),A([y({type:String})],H.prototype,`nightStart`,void 0),A([y({type:String})],H.prototype,`nightEnd`,void 0),A([y({type:Number})],H.prototype,`nightHeatDelta`,void 0),A([y({type:Number})],H.prototype,`nightCoolDelta`,void 0),A([y({type:Number})],H.prototype,`nightRampMinutes`,void 0),H=A([v(`rs-comfort-section`)],H),_(),x(),j();var Yt=class extends g{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.selectedPresencePersons=[],this.ignorePresence=!1,this.editing=!1,this.language=`en`}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}get _allPersons(){let e=this.selectedPresencePersons.filter(e=>!this.presencePersons.includes(e));return[...this.presencePersons,...e]}_isMissing(e){return!this.hass.states[e]}render(){return!this.presenceEnabled||!this.editing&&this._allPersons.length===0?h:this.editing?m`
    ...
    `}_onIgnoreToggle(e){this.dispatchEvent(new CustomEvent(`ignore-presence-changed`,{detail:e.detail,bubbles:!0,composed:!0}))}_onTogglePerson(e,t){let n;n=t?this.selectedPresencePersons.filter(t=>t!==e):[...this.selectedPresencePersons,e],this.dispatchEvent(new CustomEvent(`presence-persons-changed`,{detail:n,bubbles:!0,composed:!0}))}};A([y({attribute:!1})],Yt.prototype,`hass`,void 0),A([y({type:Boolean})],Yt.prototype,`presenceEnabled`,void 0),A([y({attribute:!1})],Yt.prototype,`presencePersons`,void 0),A([y({attribute:!1})],Yt.prototype,`selectedPresencePersons`,void 0),A([y({type:Boolean})],Yt.prototype,`ignorePresence`,void 0),A([y({type:Boolean})],Yt.prototype,`editing`,void 0),A([y()],Yt.prototype,`language`,void 0),Yt=A([v(`rs-presence-section`)],Yt),_(),x(),j();var Xt=class extends g{constructor(...e){super(...e),this.label=``,this.suffix=``,this.hint=``}static{this.styles=[L,l`
      :host {
        display: block;
      }
    ...
    `}_onInput(e){let t=parseFloat(e.target.value);isNaN(t)||this.dispatchEvent(new CustomEvent(`value-changed`,{detail:t,bubbles:!0,composed:!0}))}};A([y({type:String})],Xt.prototype,`label`,void 0),A([y({type:String})],Xt.prototype,`suffix`,void 0),A([y({type:Number})],Xt.prototype,`value`,void 0),A([y({type:Number})],Xt.prototype,`min`,void 0),A([y({type:Number})],Xt.prototype,`max`,void 0),A([y({type:Number})],Xt.prototype,`step`,void 0),A([y({type:String})],Xt.prototype,`hint`,void 0),Xt=A([v(`rs-threshold-field`)],Xt),_(),x(),j();var Zt=class extends Rt{constructor(...e){super(...e),this.schedules=[]}static{this.styles=[Rt.sharedStyles,L,l`
      .pos-badge {
        font-size: 0.8em;
        padding: 1px 6px;
        border-radius: 10px;
    ...
    `]}render(){let e=this.hass.language;return this.editing?this._renderEdit(e):this._renderView(e)}_renderView(e){let t=[...this.selectedCovers];return t.length===0?m`<p class="no-items">${S(`covers.no_covers`,e)}</p>`:m`
      ${t.map(t=>{let n=this.hass.states[t],r=n?.attributes?.friendly_name??t,i=n?.attributes?.current_position,a=this.coverOrientations[t],o=a===void 0?void 0:Qt._DIRECTIONS.find(e=>e.deg===a),s=o?S(o.shortLabel,e):void 0,c=this.coverMinPositions[t];return m`
          <div class="view-row">
      ...
      ${this.forcedReason===`schedule_active`?m`
          ...
          `:this.forcedReason===`night_close`?m`
            ...
            `:h}
    `}_renderMasterRow(e,t){let n=this.selectedCovers.has(e),r=this._selectedForEdit===e,i=this.hass.states[e],a=i?.attributes?.friendly_name||e,o=i?.attributes?.current_position,s=this.hass.language,c=this.coverOrientations[e],l=c===void 0?void 0:Qt._DIRECTIONS.find(e=>e.deg===c),u=l?S(l.shortLabel,s):``,d=this.coverMinPositions[e];return m`
      <div
    ...
    `}_renderCoverDetail(e){let t=this.hass.language,n=this.hass.states[e]?.attributes?.friendly_name||e,r=this.coverOrientations[e],i=this.coverMinPositions[e];return m`
      ...
      <div class="detail-field">
        <ha-select
          ...
          .options=${[{value:``,label:S(`covers.orientation_none`,t)},...Qt._DIRECTIONS.map(e=>({value:String(e.deg),label:S(e.longLabel,t)}))]}
          fixedMenuPosition
          @selected=${t=>{let n=F(t);this._setOrientation(e,n===``?void 0:Number(n))}}
          @closed=${e=>e.stopPropagation()}
        >
          <ha-list-item value="">${S(`covers.orientation_none`,t)}</ha-list-item>
          ${Qt._DIRECTIONS.map(e=>m`
    ...
    `}_renderEdit(e){let t=bt(this.area.area_id,this.hass?.entities,this.hass?.devices).filter(e=>!e.entity_id.substring(e.entity_id.indexOf(`.`)+1).startsWith(`roommind_`)).filter(e=>e.entity_id.startsWith(`cover.`)),n=new Set(t.map(e=>e.entity_id)),r=[...this.selectedCovers].filter(e=>!n.has(e)),i=this.selectedCovers.size>0,a=this._selectedForEdit,o=a&&this.selectedCovers.has(a);return m`
      ...
      ${i?m`
            ...
            ${this.autoEnabled?m`
                ...
                `:h}
          `:h}
    `}static{this._DIRECTIONS=[{shortLabel:`covers.orientation_N`,longLabel:`covers.orientation_N_full`,deg:0},{shortLabel:`covers.orientation_NE`,longLabel:`covers.orientation_NE_full`,deg:45},{shortLabel:`covers.orientation_E`,longLabel:`covers.orientation_E_full`,deg:90},{shortLabel:`covers.orientation_SE`,longLabel:`covers.orientation_SE_full`,deg:135},{shortLabel:`covers.orientation_S`,longLabel:`covers.orientation_S_full`,deg:180},{shortLabel:`covers.orientation_SW`,longLabel:`covers.orientation_SW_full`,deg:225},{shortLabel:`covers.orientation_W`,longLabel:`covers.orientation_W_full`,deg:270},{shortLabel:`covers.orientation_NW`,longLabel:`covers.orientation_NW_full`,deg:315}]}_setMinPosition(e,t){let n={...this.coverMinPositions};n[e]=t,this._emit(`cover_min_positions`,n)}_setOrientation(e,t){let n={...this.coverOrientations};t===void 0?delete n[e]:n[e]=t,this._emit(`cover_orientations`,n)}_onEntityPicked(e){e.stopPropagation();let t=e.detail.value;if(!t)return;this._onToggle(t,!0);let n=e.target;n.value=``}_onToggle(e,t){this.dispatchEvent(new CustomEvent(`covers-toggle`,{detail:{entityId:e,checked:t},bubbles:!0,composed:!0}))}_onResumeAuto(){this.dispatchEvent(new CustomEvent(`cover-resume-auto`,{bubbles:!0,composed:!0}))}_emit(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}};A([y({attribute:!1})],U.prototype,`hass`,void 0),A([y({attribute:!1})],U.prototype,`area`,void 0),A([y({attribute:!1})],U.prototype,`selectedCovers`,void 0),A([y({type:Boolean})],U.prototype,`editing`,void 0),A([y({type:Boolean})],U.prototype,`autoEnabled`,void 0),A([y({type:Number})],U.prototype,`deployThreshold`,void 0),A([y({type:Number})],U.prototype,`minPosition`,void 0),A([y({type:Number})],U.prototype,`overrideMinutes`,void 0),A([y({type:Boolean})],U.prototype,`autoPaused`,void 0),A([y({type:Number})],U.prototype,`overrideUntil`,void 0),A([y({attribute:!1})],U.prototype,`coverSchedules`,void 0),A([y({type:String})],U.prototype,`coverScheduleSelectorEntity`,void 0),A([y({type:Number})],U.prototype,`activeCoverScheduleIndex`,void 0),A([y({type:Boolean})],U.prototype,`nightClose`,void 0),A([y({type:Number})],U.prototype,`nightPosition`,void 0),A([y({type:Boolean})],U.prototype,`snapDeploy`,void 0),A([y({type:String})],U.prototype,`forcedReason`,void 0),A([y({attribute:!1})],U.prototype,`coverOrientations`,void 0),A([y({type:Number})],U.prototype,`nightCloseElevation`,void 0),A([y({type:Number})],U.prototype,`nightCloseOffsetMinutes`,void 0),A([y({type:Number})],U.prototype,`outdoorMinTemp`,void 0),A([y({attribute:!1})],U.prototype,`coverMinPositions`,void 0),A([b()],U.prototype,`_selectedForEdit`,void 0),A([b()],U.prototype,`_scheduleCollapsed`,void 0),A([b()],U.prototype,`_solarCollapsed`,void 0),U=Qt=A([v(`rs-covers-section`)],U),_(),x(),j();var $t=class extends g{constructor(...e){super(...e),this.enabled=!1,this.native=!1,this.heatPumpPower=0,this.primaryDelta=1.5,this.outdoorThreshold=5,this.acMinOutdoor=-15,this.editing=!1}static{this.styles=[L,l`
      :host {
        display: block;
      }
    ...
    `}_onSwitchChange(e){this._emit(`heat_source_orchestration`,e.target.checked)}_onNumberInput(e,t){let n=parseFloat(t.target.value);isNaN(n)||this._emit(e,n)}_emit(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}};A([y({attribute:!1})],$t.prototype,`hass`,void 0),A([y({type:Boolean})],$t.prototype,`enabled`,void 0),A([y({type:Boolean})],$t.prototype,`native`,void 0),A([y({type:Number})],$t.prototype,`heatPumpPower`,void 0),A([y({type:Number})],$t.prototype,`primaryDelta`,void 0),A([y({type:Number})],$t.prototype,`outdoorThreshold`,void 0),A([y({type:Number})],$t.prototype,`acMinOutdoor`,void 0),A([y({type:Boolean})],$t.prototype,`editing`,void 0),$t=A([v(`rs-heat-source-section`)],$t),_(),x(),j();var en=`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,tn=`M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z`,nn=class extends g{constructor(...e){super(...e),this.open=!1,this.heading=``,this.icon=``,this.hasInfo=!1,this._infoExpanded=!1,this._onKeyDown=e=>{e.key===`Escape`&&this.open&&(e.stopPropagation(),this._close())}}connectedCallback(){super.connectedCallback(),window.addEventListener(`keydown`,this._onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`keydown`,this._onKeyDown)}static{this.styles=l`
    :host {
      display: contents;
    }
        ...
        <div class="detail-grid">
          ${this._isOutdoor?h:m`
                <rs-section-card
                  ...
                  .heading=${S(`room.climate_control_toggle`,this.hass.language)}
                >
                  ...
                  <rs-toggle-row
                    .label=${S(`comfort.control_enabled`,this.hass.language)}
          ...
          <rs-section-card
            class="optional-card"
            icon="mdi:tree"
            .heading=${S(`room.section.area`,this.hass.language)}
          >
            <rs-toggle-row
  ...
  `}render(){return m`
      ...
      />
    `}_onChange(e){this.checked=e.target.checked,this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}},A([y({type:Boolean,reflect:!0})],on.prototype,`checked`,void 0),A([y({type:Boolean,reflect:!0})],on.prototype,`disabled`,void 0),A([y({type:String})],on.prototype,`name`,void 0),A([y({type:String})],on.prototype,`value`,void 0)})),cn=n({HaTextfieldPolyfill:()=>G}),G,ln=t((()=>{_(),x(),j(),G=class extends g{constructor(...e){super(...e),this.value=``,this.type=`text`,this.label=``,this.placeholder=``,this.suffix=``,this.prefix=``,this.helper=``,this.disabled=!1,this.required=!1,this.readOnly=!1,this.min=``,this.max=``,this.step=null,this.name=``}static{this.shadowRootOptions={mode:`open`,delegatesFocus:!0}}static{this.styles=l`
    :host {
      display: inline-flex;
      flex-direction: column;
      outline: none;
  ...
  `}};A([y({type:String})],_n.prototype,`icon`,void 0),A([y({type:String})],_n.prototype,`heading`,void 0),A([y({type:String})],_n.prototype,`intro`,void 0),A([y({type:String})],_n.prototype,`badge`,void 0),A([y({type:String})],_n.prototype,`badgeHint`,void 0),_n=A([v(`rs-settings-panel`)],_n),_();var K=class extends g{_fire(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}static{this.settingsBaseStyles=l`
    :host {
      display: block;
    }
  ...
  `}};_(),x(),j();var vn=class extends g{constructor(...e){super(...e),this.options=[],this.selected=``}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onRadioChange(e){let t=e.target;t.checked&&this.dispatchEvent(new CustomEvent(`selected-changed`,{detail:t.value,bubbles:!0,composed:!0}))}};A([y({type:Array})],vn.prototype,`options`,void 0),A([y({type:String})],vn.prototype,`selected`,void 0),vn=A([v(`rs-radio-group`)],vn),_(),x(),j();var yn=class extends K{constructor(...e){super(...e),this.groupByFloor=!1,this.climateControlActive=!0,this.temperatureRoundingMode=`nearest`}render(){let e=this.hass.language;return m`
    ...
    `]}};A([y({attribute:!1})],bn.prototype,`hass`,void 0),A([y({type:String})],bn.prototype,`outdoorTempSensor`,void 0),A([y({type:String})],bn.prototype,`outdoorHumiditySensor`,void 0),A([y({type:String})],bn.prototype,`weatherEntity`,void 0),A([y({type:Boolean})],bn.prototype,`outdoorUnavailableNotify`,void 0),bn=A([v(`rs-settings-sensors`)],bn),_(),x(),j();var xn=`https://github.com/snazzybean/roommind/blob/main/docs/control-and-devices.md`,Sn=class extends K{constructor(...e){super(...e),this.controlMode=`mpc`,this.comfortWeight=70,this.outdoorCoolingMin=16,this.outdoorHeatingMax=22,this.predictionEnabled=!0,this.scheduleOffAction=`eco`}render(){let e=this.hass.language;return m`
      <div class="settings-section first">
      ...
      <div class="settings-section">
        ...
        <a class="helper-link" href=${xn} target="_blank" rel="noreferrer">
          ${S(`common.learn_more`,e)}
        </a>
      </div>
    ...
    `]}};A([y({attribute:!1})],Sn.prototype,`hass`,void 0),A([y({type:String})],Sn.prototype,`controlMode`,void 0),A([y({type:Number})],Sn.prototype,`comfortWeight`,void 0),A([y({type:Number})],Sn.prototype,`outdoorCoolingMin`,void 0),A([y({type:Number})],Sn.prototype,`outdoorHeatingMax`,void 0),A([y({type:Boolean})],Sn.prototype,`predictionEnabled`,void 0),A([y({type:String})],Sn.prototype,`scheduleOffAction`,void 0),Sn=A([v(`rs-settings-control`)],Sn),_(),x(),j();var Cn=class extends K{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.presenceAwayAction=`eco`,this.presenceClearsOverride=!1}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};A([y({attribute:!1})],Cn.prototype,`hass`,void 0),A([y({type:Boolean})],Cn.prototype,`presenceEnabled`,void 0),A([y({type:Array})],Cn.prototype,`presencePersons`,void 0),A([y({type:String})],Cn.prototype,`presenceAwayAction`,void 0),A([y({type:Boolean})],Cn.prototype,`presenceClearsOverride`,void 0),Cn=A([v(`rs-settings-presence`)],Cn),_(),x(),j();var wn=class extends K{constructor(...e){super(...e),this.vacationActive=!1,this.vacationTemp=15,this.vacationUntil=``}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.vacationActive?m`
          ...
          `:h}
    `}static{this.styles=[K.settingsBaseStyles]}};A([y({attribute:!1})],wn.prototype,`hass`,void 0),A([y({type:Boolean})],wn.prototype,`vacationActive`,void 0),A([y({type:Number})],wn.prototype,`vacationTemp`,void 0),A([y({type:String})],wn.prototype,`vacationUntil`,void 0),wn=A([v(`rs-settings-vacation`)],wn),_(),x(),j();var Tn=class extends K{constructor(...e){super(...e),this.valveProtectionEnabled=!1,this.valveProtectionInterval=7}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.valveProtectionEnabled?m`
          ...
          `:h}
    `}static{this.styles=[K.settingsBaseStyles]}};A([y({attribute:!1})],Tn.prototype,`hass`,void 0),A([y({type:Boolean})],Tn.prototype,`valveProtectionEnabled`,void 0),A([y({type:Number})],Tn.prototype,`valveProtectionInterval`,void 0),Tn=A([v(`rs-settings-valve`)],Tn),_(),x(),j();var En=class extends g{constructor(...e){super(...e),this.label=``,this.confirmMessage=``,this.disabled=!1,this.destructive=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return m`
    ...
    `}_onClick(){this.disabled||this.confirmMessage&&!confirm(this.confirmMessage)||this.dispatchEvent(new CustomEvent(`confirmed`,{bubbles:!0,composed:!0}))}};A([y({type:String})],En.prototype,`label`,void 0),A([y({type:String})],En.prototype,`confirmMessage`,void 0),A([y({type:Boolean})],En.prototype,`disabled`,void 0),A([y({type:Boolean})],En.prototype,`destructive`,void 0),En=A([v(`rs-confirm-button`)],En),_(),x(),j();var Dn=class extends g{constructor(...e){super(...e),this.compressorGroups=[],this._memberFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0},this._masterFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0}}static{this.styles=[L,l`
      :host {
        display: block;
      }
      .group-card {
    ...
    `}_updateGroup(e,t,n){let r=[...this.compressorGroups];r[e]={...r[e],[t]:n},this._fire(r)}_addGroup(){this._fire([...this.compressorGroups,{id:self.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,name:``,members:[],min_run_minutes:15,min_off_minutes:5,master_entity:``,conflict_resolution:`heating_priority`,action_script:``,enforce_uniform_mode:!1}])}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`compressorGroups`,value:e},bubbles:!0,composed:!0}))}};A([y({attribute:!1})],Dn.prototype,`hass`,void 0),A([y({type:Array})],Dn.prototype,`compressorGroups`,void 0),Dn=A([v(`rs-settings-compressor`)],Dn),_(),x(),j();var q=class extends K{constructor(...e){super(...e),this.moldDetectionEnabled=!1,this.moldHumidityThreshold=70,this.moldSustainedMinutes=30,this.moldPreventionEnabled=!1,this.moldPreventionIntensity=`medium`,this.moldPreventionDehumidificationEnabled=!0,this.moldPreventionDryMinTemperature=23}render(){let e=this.hass.language,t=k(15,30,this.hass);return m`
      <!-- Detection section -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
      ...
      <div class="settings-section">
        ...
        ${this.moldPreventionEnabled?m`
              ...
              <div class="settings-section" style="margin-top: 16px">
                <div class="toggle-row">
                  <div class="toggle-text">
                    <span class="toggle-label">${S(`mold.dehumidification`,e)}</span>
                    <span class="toggle-hint">${S(`mold.dehumidification_desc`,e)}</span>
                  </div>
                  <ha-switch
                    .checked=${this.moldPreventionDehumidificationEnabled}
                    @change=${e=>this._fire(`moldPreventionDehumidificationEnabled`,e.target.checked)}
                  ></ha-switch>
                </div>
                ${this.moldPreventionDehumidificationEnabled?m`
                      <div class="threshold-field" style="margin-top: 12px">
                        <ha-textfield
                          .value=${String(w(this.moldPreventionDryMinTemperature,this.hass))}
                          .label=${S(`mold.dehumidification_min_temperature`,e)}
                          .suffix=${C(this.hass)}
                          type="number"
                          step=${O(this.hass)}
                          min=${t.min}
                          max=${t.max}
                          @change=${e=>{let t=T(parseFloat(e.target.value),this.hass);!isNaN(t)&&t>=15&&t<=30&&this._fire(`moldPreventionDryMinTemperature`,t)}}
                        ></ha-textfield>
                        <span class="field-hint"
                          >${S(`mold.dehumidification_min_temperature_hint`,e)}</span
                        >
                      </div>
                    `:h}
              </div>
    ...
    `}static{this.styles=[K.settingsBaseStyles]}};A([y({attribute:!1})],q.prototype,`hass`,void 0),A([y({type:Boolean})],q.prototype,`moldDetectionEnabled`,void 0),A([y({type:Number})],q.prototype,`moldHumidityThreshold`,void 0),A([y({type:Number})],q.prototype,`moldSustainedMinutes`,void 0),A([y({type:Boolean})],q.prototype,`moldPreventionEnabled`,void 0),A([y({type:String})],q.prototype,`moldPreventionIntensity`,void 0),A([y({type:Boolean})],q.prototype,`moldPreventionDehumidificationEnabled`,void 0),A([y({type:Number})],q.prototype,`moldPreventionDryMinTemperature`,void 0),q=A([v(`rs-settings-mold`)],q),_(),x(),j();var On=class extends K{constructor(...e){super(...e),this.notificationsEnabled=!0,this.notificationTargets=[],this.notificationCooldown=60,this.moldPreventionEnabled=!1,this.moldPreventionNotify=!1,this.windowOpenNotificationMinutes=0}render(){let e=this.hass.language;return m`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};A([y({attribute:!1})],On.prototype,`hass`,void 0),A([y({type:Boolean})],On.prototype,`notificationsEnabled`,void 0),A([y({type:Array})],On.prototype,`notificationTargets`,void 0),A([y({type:Number})],On.prototype,`notificationCooldown`,void 0),A([y({type:Boolean})],On.prototype,`moldPreventionEnabled`,void 0),A([y({type:Boolean})],On.prototype,`moldPreventionNotify`,void 0),A([y({type:Number})],On.prototype,`windowOpenNotificationMinutes`,void 0),On=A([v(`rs-settings-notifications`)],On),_(),x(),j();var kn=250,An=class extends K{constructor(...e){super(...e),this.rooms={},this.learningDisabledRooms=[],this.boostAppliedAt={},this.roomsLive={},this._showLearningExceptions=!1,this._boostSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name)),n=Object.keys(this.rooms),r=n.length===0||this.learningDisabledRooms.length<n.length,i=this.learningDisabledRooms.filter(e=>n.includes(e)).length;return m`
      <!-- Learning toggle -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}_isCooldown(e){let t=this.roomsLive?.[e]?.n_observations??0,n=this.boostAppliedAt[e];return n!==void 0&&t-n<kn}async _boostLearning(e){try{I(this,`saving`);let t=await this.hass.callWS({type:`roommind/model/boost_learning`,area_id:e});I(this,`saved`),this.dispatchEvent(new CustomEvent(`boost-applied`,{detail:{area_id:e,n_observations:t.n_observations},bubbles:!0,composed:!0}))}catch{I(this,`error`)}}static{this.styles=[K.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 4px 0 12px;
    ...
    `]}};A([y({attribute:!1})],An.prototype,`hass`,void 0),A([y({attribute:!1})],An.prototype,`rooms`,void 0),A([y({type:Array})],An.prototype,`learningDisabledRooms`,void 0),A([y({attribute:!1})],An.prototype,`boostAppliedAt`,void 0),A([y({attribute:!1})],An.prototype,`roomsLive`,void 0),A([b()],An.prototype,`_showLearningExceptions`,void 0),A([b()],An.prototype,`_boostSelectedRoom`,void 0),An=A([v(`rs-settings-learning`)],An),_(),x(),j();var jn=class extends K{constructor(...e){super(...e),this.rooms={},this._resetSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name));return m`
      <div class="settings-section first">
        <div class="reset-row">
    ...
    `]}};A([y({attribute:!1})],jn.prototype,`hass`,void 0),A([y({attribute:!1})],jn.prototype,`rooms`,void 0),A([b()],jn.prototype,`_resetSelectedRoom`,void 0),jn=A([v(`rs-settings-reset`)],jn),_(),x(),j();var Mn={entity:{multiple:!0,filter:[{domain:`climate`}]}},J=class extends g{constructor(...e){super(...e),this.boilerEntity=``,this.boilerControlType=`climate`,this.bypassEntities=[],this.startupDelay=30,this.shutdownDelay=60,this.bypassTemperature=28,this.budgetEnabled=!1,this.powerSensor=``,this.powerMode=`available`,this.maxPower=3300,this.reserve=200,this.energyPricePerKwh=0,this._powerModeState={value:`available`,hasLocalChange:!1}}willUpdate(e){e.has(`powerMode`)&&(this._powerModeState=mn(this._powerModeState,this.powerMode))}render(){let e=(e,t)=>this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0})),t=(t,n)=>m`<ha-textfield
        type="number"
        .value=${String(n)}
      ...
      ></ha-textfield>`,n=e=>{let t=e.detail,n=e.target,r=e.currentTarget;if(typeof t==`string`||Array.isArray(t))return t;if(t&&typeof t==`object`){let e=t;return e.value??e.values??e.selected}return n?.value??n?.values??n?.selected??r?.value??r?.values};return m`<div class="section">
        ...
        ${this.boilerEntity?m`<ha-select
              ...
              <ha-selector
                ...
                @value-changed=${t=>{let r=n(t);console.debug(`RoomMind hydraulic bypass picker event`,{type:t.type,detail:t.detail,targetValue:t.target?.value,currentTargetValue:t.currentTarget?.value,value:r}),e(`bypassEntities`,dn(r))}}
              ></ha-selector>
              <small
      ...
      <div class="section">
        ...
        ${this.budgetEnabled?m`<ha-entity-picker
              ...
              ><ha-select
                ...
                @selected=${t=>{let n=F(t);console.debug(`RoomMind power sensor mode selected`,{type:t.type,detail:t.detail,targetValue:t.target?.value,currentTargetValue:t.currentTarget?.value,value:n}),this._powerModeState=pn(n),e(`powerMode`,this._powerModeState.value)}}
              ></ha-select>
              <div class="grid">
...
`)}function Pn(e,t,n){let r=new Blob([e],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}function Fn(e,t,n,r,i,a,o){let s=e?.areas?.[n],c=(t[n]?.display_name||s?.name||n).replace(/\s+/g,`_`).toLowerCase();return a?`roommind_${a}_${c}.${o}`:`roommind_${c}_${new Date(r).toISOString().slice(0,10)}_${new Date(i).toISOString().slice(0,10)}.${o}`}function In(e){return navigator.clipboard?.writeText?(navigator.clipboard.writeText(e).catch(()=>{Ln(e)}),!0):Ln(e)}function Ln(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch(e){console.debug(`[RoomMind] clipboard fallback:`,e)}return document.body.removeChild(t),n}_(),x(),j();var X=class extends g{constructor(...e){super(...e),this.rooms={},this.selectedRoom=``,this.rangeStart=0,this.rangeEnd=0,this.activeQuick=`24h`,this.data=null,this.language=`en`,this._openDropdown=null,this._diagLoading=!1,this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this._boundCloseDropdowns)}updated(e){(e.has(`rooms`)||e.has(`selectedRoom`))&&this.selectedRoom&&this.updateComplete.then(()=>{let e=this.renderRoot?.querySelector(`ha-select`);e&&e.value!==this.selectedRoom&&(e.value=this.selectedRoom)})}render(){let e=this.language,t=this._getConfiguredRooms();return m`
    ...
    `}_onRoomSelected(e){let t=F(e);t&&t!==this.selectedRoom&&this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0}))}_onQuickRange(e,t){let n=new Date,r=new Date(n);r.setDate(r.getDate()-(t-1)),r.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:e,rangeStart:r.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_onDateRangeChanged(e){let{startDate:t,endDate:n}=e.detail.value;!t||!n||this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:null,rangeStart:t.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_exportCsv(){if(!this.data)return;let e=Nn(this.data);e&&(Pn(e,Fn(this.hass,this.rooms,this.selectedRoom,this.rangeStart,this.rangeEnd,``,`csv`),`text/csv`),this._openDropdown=null)}async _exportDiagnostics(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});Pn(JSON.stringify(e,null,2),`roommind_diagnostics.json`,`application/json`)}catch(e){console.warn(`[RoomMind] diagnostics export failed:`,e)}finally{this._diagLoading=!1}}}_copyCsvToClipboard(){if(!this.data)return;let e=Nn(this.data);e&&(In(e),this._openDropdown=null)}async _copyDiagnosticsToClipboard(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind/diagnostics/get`});In(JSON.stringify(e,null,2))}catch(e){console.warn(`[RoomMind] diagnostics clipboard failed:`,e)}finally{this._diagLoading=!1}}}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&=null}static{this.styles=[L,l`
      :host {
        display: block;
      }
    ...
    `]}};A([y({attribute:!1})],X.prototype,`hass`,void 0),A([y({attribute:!1})],X.prototype,`rooms`,void 0),A([y({type:String})],X.prototype,`selectedRoom`,void 0),A([y({type:Number})],X.prototype,`rangeStart`,void 0),A([y({type:Number})],X.prototype,`rangeEnd`,void 0),A([y({type:String})],X.prototype,`activeQuick`,void 0),A([y({attribute:!1})],X.prototype,`data`,void 0),A([y({type:String})],X.prototype,`language`,void 0),A([b()],X.prototype,`_openDropdown`,void 0),A([b()],X.prototype,`_diagLoading`,void 0),X=A([v(`rs-analytics-toolbar`)],X),_();var Rn=l`
  .info-icon {
    --mdc-icon-size: 16px;
    color: var(--secondary-text-color);
    opacity: 0.3;
...
`,zn=108e5;function Bn(e,t){let{hass:n,language:r,chartAnchor:i,forecast:a,isOutdoor:o}=t,s=e=>w(e,n),c=[],l=[],u=[],d=[],f=[];for(let t of e){let e=t.ts*1e3;t.room_temp!==null&&c.push([e,s(t.room_temp)]),!o&&t.target_temp!==null&&l.push([e,s(t.target_temp)]),!o&&t.predicted_temp!==null&&u.push([e,s(t.predicted_temp)]),t.outdoor_temp!==null&&d.push([e,s(t.outdoor_temp)]),!o&&t.device_setpoint!=null&&f.push([e,s(t.device_setpoint)])}for(let e of a??[]){let t=e.ts*1e3;!o&&e.target_temp!==null&&l.push([t,s(e.target_temp)]),!o&&e.predicted_temp!==null&&u.push([t,s(e.predicted_temp)])}let p=[{id:`room_temp`,type:`line`,name:S(`analytics.temperature`,r),color:`rgb(255, 152, 0)`,data:c,showSymbol:!1,smooth:!0,lineStyle:{width:2},yAxisIndex:0}];o||p.push({id:`target_temp`,type:`line`,name:S(`analytics.target`,r),color:`rgb(76, 175, 80)`,data:l,showSymbol:!1,smooth:!1,lineStyle:{width:2,type:`dashed`},yAxisIndex:0}),u.length>0&&p.push({id:`predicted_temp`,type:`line`,name:S(`analytics.prediction`,r),color:`rgb(33, 150, 243)`,data:u,showSymbol:!1,smooth:!0,lineStyle:{width:2,type:`dotted`},yAxisIndex:0}),f.length>0&&p.push({id:`device_target`,type:`line`,name:`TRV / AC`,color:`rgb(156, 39, 176)`,data:f,showSymbol:!1,smooth:!1,step:`end`,lineStyle:{width:1,type:`dashed`},yAxisIndex:0}),d.length>0&&p.push({id:`outdoor_temp`,type:`line`,name:S(`analytics.outdoor`,r),color:`rgb(158, 158, 158)`,data:d,showSymbol:!1,smooth:!0,lineStyle:{width:1},yAxisIndex:0});let ee=[],te=[],ne=[],re=!1,ie=!1,ae=!1;for(let t of e){let e=t.ts*1e3;t.mode===`heating`?(ee.push([e,999]),re=!0):ee.push([e,null]),t.mode===`cooling`?(te.push([e,999]),ie=!0):te.push([e,null]),t.window_open?(ne.push([e,999]),ae=!0):ne.push([e,null])}return re&&p.push({id:`heating_events`,type:`line`,name:S(`analytics.heating_period`,r),color:`rgb(244, 67, 54)`,data:ee,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(244, 67, 54, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),ie&&p.push({id:`cooling_events`,type:`line`,name:S(`analytics.cooling_period`,r),color:`rgb(63, 81, 181)`,data:te,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(63, 81, 181, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),ae&&p.push({id:`window_events`,type:`line`,name:S(`analytics.window_open_period`,r),color:`rgb(0, 150, 136)`,data:ne,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(0, 150, 136, 0.1)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),p.push({id:`now_marker`,type:`line`,name:``,color:`rgba(255,255,255,0.3)`,data:[[i,-999],[i,999]],showSymbol:!1,lineStyle:{width:1,type:`dashed`},yAxisIndex:0,tooltip:{show:!1},z:-2}),p}function Vn(e,t,n){let{hass:r,language:i,chartAnchor:a,rangeStart:o,rangeEnd:s}=n,c=C(r),l={type:`value`,name:c};if(e.length>0){let t=1/0,n=-1/0;for(let r of e)r<t&&(t=r),r>n&&(n=r);let r=n-t,i=Math.max(r*.1,.5);l.min=Math.floor((t-i)*2)/2,l.max=Math.ceil((n+i)*2)/2}return{xAxis:{type:`time`,min:o,max:Math.abs(s-Date.now())<36e5?a+zn:s},yAxis:l,dataZoom:[{type:`inside`,xAxisIndex:0,filterMode:`none`}],tooltip:{trigger:`axis`,axisPointer:{snap:!1},valueFormatter:e=>e.toFixed(1)+`\xA0`+c,formatter:e=>{if(!Array.isArray(e)||e.length===0)return``;let n=`<div style="font-weight:500;margin-bottom:4px">${new Date(e[0].value[0]).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}</div>`,a=null,o=null;for(let t of e){if(t.seriesId?.endsWith(`_events`))continue;let e=t.value?.[1];e!=null&&(n+=`<div>${t.color?`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.color};margin-right:6px"></span>`:``}${t.seriesName}: ${e.toFixed(1)}\u00A0${c}</div>`,t.seriesId===`room_temp`&&(a=e),t.seriesId===`predicted_temp`&&(o=e))}if(a!==null&&o!==null){let e=a-o;n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px">Delta: ${e>=0?`+`:``}${e.toFixed(2)}\u00A0${c}</div>`}if(t.length>0){let a=e[0].value[0]/1e3,o=null,s=1/0;for(let e of t){let t=Math.abs(e.ts-a);t<s&&(s=t,o=e)}if(o){let e=[];if(o.mode===`heating`){let t=o.heating_power;t!=null&&t>0&&t<100?e.push(`${S(`analytics.heating_period`,i)} ${t}%`):e.push(S(`analytics.heating_period`,i)),o.device_setpoint!=null&&e.push(`TRV ${D(o.device_setpoint,r)}\u00A0${c}`)}else o.mode===`cooling`&&(e.push(S(`analytics.cooling_period`,i)),o.device_setpoint!=null&&e.push(`AC ${D(o.device_setpoint,r)}\u00A0${c}`));o.window_open&&e.push(S(`analytics.window_open_period`,i)),e.length>0&&(n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px;color:rgba(255,255,255,0.7)">${e.join(` · `)}</div>`),o.blind_position!=null&&(n+=`<div style="color:rgba(255,255,255,0.7)">${S(`analytics.blind_position`,i)} ${100-o.blind_position}%</div>`)}}let s=document.createElement(`div`);return s.innerHTML=n,s}},grid:{top:15,left:10,right:10,bottom:5,containLabel:!0}}}_(),x(),j();var Z=class extends g{constructor(...e){super(...e),this.data=null,this.rangeStart=0,this.rangeEnd=0,this.chartAnchor=0,this.language=`en`,this.isOutdoor=!1,this._hiddenSeries=new Set([`outdoor_temp`,`device_target`]),this._chartInfoExpanded=!1}render(){let e=this.language,t=this.data?[...this.data.history,...this.data.detail]:[],n=[...t,...this.data?.forecast??[]],r={hass:this.hass,language:e,chartAnchor:this.chartAnchor,rangeStart:this.rangeStart,rangeEnd:this.rangeEnd,forecast:this.data?.forecast,isOutdoor:this.isOutdoor},i=t.length>0?Bn(t,r):[],a=[],o=i.map(e=>{let t=e.id,n=e.lineStyle||{},r=t.endsWith(`_events`);if(this._hiddenSeries.has(t)){let t={...e,lineStyle:{...n,width:0,opacity:0}};return e.areaStyle&&(t.areaStyle={...e.areaStyle,opacity:0}),t}if(!r&&t!==`now_marker`)for(let t of e.data)t&&t[1]!=null&&a.push(t[1]);let i={...e,lineStyle:{...n,opacity:1}};return e.areaStyle&&(i.areaStyle={...e.areaStyle,opacity:1}),i}),s=Vn(a,n,r);return m`
      <ha-card>
        <div class="card-header">
...
`).map(e=>m`<p>
        ...
        </p>`)}_toggleSeries(e){let t=new Set(this._hiddenSeries);t.has(e)?t.delete(e):t.add(e),this._hiddenSeries=t}static{this.styles=[Rn,l`
      :host {
        display: block;
      }
    ...
    `]}};A([y({attribute:!1})],Wn.prototype,`hass`,void 0),A([y({attribute:!1})],Wn.prototype,`data`,void 0),A([y({type:Number})],Wn.prototype,`rangeStart`,void 0),A([y({type:Number})],Wn.prototype,`rangeEnd`,void 0),A([y({type:Number})],Wn.prototype,`chartAnchor`,void 0),A([y({type:String})],Wn.prototype,`language`,void 0),A([b()],Wn.prototype,`_hiddenSeries`,void 0),A([b()],Wn.prototype,`_chartInfoExpanded`,void 0),Wn=A([v(`rs-energy-analytics-chart`)],Wn),_(),x(),j();var Gn=class extends g{constructor(...e){super(...e),this.data=null,this.language=`en`,this._expandedStat=null}render(){let e=this.language,t=!!this.data?.model?.model,n=this.data?.model,r=n?.model,i=n?.confidence??0,a=n?.n_samples??0,o=n?.n_heating??0,s=n?.n_cooling??0,c=n?.applicable_modes??[],l=n?.prediction_std_idle,u=n?.prediction_std_heating,d=n?.mpc_active??!1,f=Math.round(i*100),p=new Set(c),ee=p.has(`heating`),te=p.has(`cooling`),ne=o>=10,re=s>=10,ie=a-o-s>=10,ae=n?.n_observations??a,oe=[],se=(t,n,r,i,a)=>{oe.push({id:t,labelKey:r,infoKey:a});let o=this._expandedStat===t;return m`
      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          <div class="model-grid">
            ...
            ${ee?se(`heating_rate`,ne&&r?E(r.Q_heat,this.hass).toFixed(1)+C(this.hass)+`/h`:`—`,`analytics.heating_rate`,``,`analytics.info.heating_rate`):h}
            ${te?se(`cooling_rate`,re&&r?E(r.Q_cool,this.hass).toFixed(1)+C(this.hass)+`/h`:`—`,`analytics.cooling_rate`,``,`analytics.info.cooling_rate`):h}
            ${r&&r.Q_solar>.1?se(`solar_gain`,E(r.Q_solar,this.hass).toFixed(1)+C(this.hass)+`/h`,`analytics.solar_gain`,``,`analytics.info.solar_gain`):h}
            ${r&&n?.has_occupancy_sensors?se(`occupancy_gain`,E(r.Q_occupancy,this.hass).toFixed(1)+C(this.hass)+`/h`,`analytics.occupancy_gain`,``,`analytics.info.occupancy_gain`):h}
            ${se(`accuracy_idle`,ie&&l!=null?`±`+E(l,this.hass).toFixed(2)+C(this.hass):`—`,`analytics.accuracy_idle`,``,`analytics.info.accuracy_idle`)}
            ${ee?se(`accuracy_heating`,ne&&u!=null?`±`+E(u,this.hass).toFixed(2)+C(this.hass):`—`,`analytics.accuracy_heating`,``,`analytics.info.accuracy_heating`):h}
          </div>
    ...
    `}_toggleStat(e){this._expandedStat=this._expandedStat===e?null:e}static{this.styles=[Rn,l`
      :host {
        display: block;
      }
                              ...
                              ${this._comparison.map(t=>m`<tr>
                                  <td>
                                    ...
                                    ${Array.isArray(t.data_quality)&&t.data_quality.length?m`<div class="comparison-quality">
                                          ...
                                          ${t.data_quality.map(t=>S(Kn._comparisonQualityKeys[t]??`analytics.comparison_data_incomplete`,e)).join(`, `)}
                                        </div>`:h}
  ...
  `}connectedCallback(){super.connectedCallback(),un().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return m``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:S(`panel.tab.rooms`,e),analytics:S(`tabs.analytics`,e),settings:S(`panel.tab.settings`,e)};return m`
      <div class="toolbar">
        ...
        ${t&&this._rooms[this._selectedAreaId]?m`<ha-icon-button
              ...
              ></ha-icon-button
              ><ha-icon-button .path=${Jn} @click=${this._onDeleteRoom}></ha-icon-button>`:h}
